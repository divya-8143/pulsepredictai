...
Clinical Reference: Aujesky et al. Am J Respir Crit Care Med 2005
...
@dataclass
class PesiPulmonaryEmbolismParameters:
...
class PesiPulmonaryEmbolismEngine:
    """
    Precision algorithmic evaluator for Pulmonary Embolism Severity Index (PESI & sPESI).
    Reference: Aujesky et al. Am J Respir Crit Care Med 2005
    """

    ALGORITHM_NAME = "Pulmonary Embolism Severity Index (PESI & sPESI)"
    CITATION = "Aujesky et al. Am J Respir Crit Care Med 2005"
    SPECIALTY = "Pulmonology"

    @classmethod
    def evaluate(cls, params: PesiPulmonaryEmbolismParameters) -> Dict[str, Any]:
        """
    ...
    @classmethod
    def _compute_raw_score(cls, params: PesiPulmonaryEmbolismParameters) -> float:
    ...
    @classmethod
    def _derive_probability(cls, raw: float, params: PesiPulmonaryEmbolismParameters) -> float:
    ...
    @classmethod
    def _generate_recommendations(cls, tier: str, params: PesiPulmonaryEmbolismParameters) -> List[Dict[str, str]]:
        recs = []
        if tier == "HIGH_RISK_INTENSIVE":
            recs.append({
                "category": "Immediate Action",
                "directive": f"High risk identified by Pulmonary Embolism Severity Index (PESI & sPESI). Urgent clinical review and telemetry monitoring recommended.",
