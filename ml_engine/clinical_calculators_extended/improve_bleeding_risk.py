"""
IMPROVE Bleeding Risk Score for Medical Inpatients
Clinical Reference: Decousus et al. Chest 2011
...
@dataclass
class ImproveBleedingRiskParameters:
...
class ImproveBleedingRiskEngine:
    """
    Precision algorithmic evaluator for IMPROVE Bleeding Risk Score for Medical Inpatients.
    Reference: Decousus et al. Chest 2011
    """

    ALGORITHM_NAME = "IMPROVE Bleeding Risk Score for Medical Inpatients"
    CITATION = "Decousus et al. Chest 2011"
    SPECIALTY = "Hematology"

    @classmethod
    def evaluate(cls, params: ImproveBleedingRiskParameters) -> Dict[str, Any]:
        """
    ...
    @classmethod
    def _compute_raw_score(cls, params: ImproveBleedingRiskParameters) -> float:
    ...
    @classmethod
    def _derive_probability(cls, raw: float, params: ImproveBleedingRiskParameters) -> float:
    ...
    @classmethod
    def _generate_recommendations(cls, tier: str, params: ImproveBleedingRiskParameters) -> List[Dict[str, str]]:
        recs = []
        if tier == "HIGH_RISK_INTENSIVE":
            recs.append({
                "category": "Immediate Action",
                "directive": f"High risk identified by IMPROVE Bleeding Risk Score for Medical Inpatients. Urgent clinical review and telemetry monitoring recommended.",
