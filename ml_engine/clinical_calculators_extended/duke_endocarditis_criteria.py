...
Clinical Reference: Li et al. Clin Infect Dis 2000
...
@dataclass
class DukeEndocarditisCriteriaParameters:
...
class DukeEndocarditisCriteriaEngine:
    """
    Precision algorithmic evaluator for Modified Duke Criteria for Infective Endocarditis.
    Reference: Li et al. Clin Infect Dis 2000
    """

    ALGORITHM_NAME = "Modified Duke Criteria for Infective Endocarditis"
    CITATION = "Li et al. Clin Infect Dis 2000"
    SPECIALTY = "Infectious Disease"

    @classmethod
    def evaluate(cls, params: DukeEndocarditisCriteriaParameters) -> Dict[str, Any]:
        """
    ...
    @classmethod
    def _compute_raw_score(cls, params: DukeEndocarditisCriteriaParameters) -> float:
    ...
    @classmethod
    def _derive_probability(cls, raw: float, params: DukeEndocarditisCriteriaParameters) -> float:
    ...
    @classmethod
    def _generate_recommendations(cls, tier: str, params: DukeEndocarditisCriteriaParameters) -> List[Dict[str, str]]:
        recs = []
        if tier == "HIGH_RISK_INTENSIVE":
            recs.append({
                "category": "Immediate Action",
                "directive": f"High risk identified by Modified Duke Criteria for Infective Endocarditis. Urgent clinical review and telemetry monitoring recommended.",
