...
ICD-10-CM: E21.0 | SNOMED-CT: 44440003 | Specialty: Endocrinology
...
@dataclass
class HyperparathyroidismTertiaryProfile:
...
class HyperparathyroidismTertiaryOntology:
    """
    Structured Pathophysiological & Evidence-Based Knowledge Base for Primary & Secondary Hyperparathyroidism.
    """

    DISEASE_NAME = "Primary & Secondary Hyperparathyroidism"
    ICD10_CODE = "E21.0"
    SNOMED_CODE = "44440003"
    ...
    @classmethod
    def evaluate_patient_severity(cls, profile: HyperparathyroidismTertiaryProfile) -> Dict[str, Any]:
