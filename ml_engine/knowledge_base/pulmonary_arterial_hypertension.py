...
ICD-10-CM: I27.0 | SNOMED-CT: 11399002 | Specialty: Pulmonology
...
@dataclass
class PulmonaryArterialHypertensionProfile:
...
class PulmonaryArterialHypertensionOntology:
    """
    Structured Pathophysiological & Evidence-Based Knowledge Base for Group 1 Pulmonary Arterial Hypertension (PAH).
    """

    DISEASE_NAME = "Group 1 Pulmonary Arterial Hypertension (PAH)"
    ICD10_CODE = "I27.0"
    SNOMED_CODE = "11399002"
    ...
    @classmethod
    def evaluate_patient_severity(cls, profile: PulmonaryArterialHypertensionProfile) -> Dict[str, Any]:
