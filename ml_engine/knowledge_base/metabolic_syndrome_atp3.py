...
ICD-10-CM: E88.81 | SNOMED-CT: 237602007 | Specialty: Metabolism
...
@dataclass
class MetabolicSyndromeAtp3Profile:
...
class MetabolicSyndromeAtp3Ontology:
    """
    Structured Pathophysiological & Evidence-Based Knowledge Base for Metabolic Syndrome (NCEP ATP III Criteria).
    """

    DISEASE_NAME = "Metabolic Syndrome (NCEP ATP III Criteria)"
    ICD10_CODE = "E88.81"
    ...
    @classmethod
    def evaluate_patient_severity(cls, profile: MetabolicSyndromeAtp3Profile) -> Dict[str, Any]:
