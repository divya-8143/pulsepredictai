...
ICD-10-CM: N18.4 | SNOMED-CT: 431857002 | Specialty: Nephrology
...
@dataclass
class ChronicKidneyDiseaseG4Profile:
...
class ChronicKidneyDiseaseG4Ontology:
    """
    Structured Pathophysiological & Evidence-Based Knowledge Base for Chronic Kidney Disease, Stage 4 (Severe).
    """

    DISEASE_NAME = "Chronic Kidney Disease, Stage 4 (Severe)"
    ICD10_CODE = "N18.4"
    ...
    @classmethod
    def evaluate_patient_severity(cls, profile: ChronicKidneyDiseaseG4Profile) -> Dict[str, Any]:
