...
ICD-10-CM: I20.1 | SNOMED-CT: 4557003 | Specialty: Cardiology
...
@dataclass
class CoronaryArterySpasmProfile:
...
class CoronaryArterySpasmOntology:
    """
    Structured Pathophysiological & Evidence-Based Knowledge Base for Coronary Microvascular Disease & Vasospastic Angina.
    """

    DISEASE_NAME = "Coronary Microvascular Disease & Vasospastic Angina"
    ICD10_CODE = "I20.1"
    SNOMED_CODE = "4557003"
    ...
    @classmethod
    def evaluate_patient_severity(cls, profile: CoronaryArterySpasmProfile) -> Dict[str, Any]:
