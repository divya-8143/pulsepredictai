...
ICD-10-CM: G47.33 | SNOMED-CT: 78275009 | Specialty: Sleep Medicine
...
@dataclass
class ObstructiveSleepApneaProfile:
...
class ObstructiveSleepApneaOntology:
    """
    Structured Pathophysiological & Evidence-Based Knowledge Base for Severe Obstructive Sleep Apnea (AHI >= 30).
    """

    DISEASE_NAME = "Severe Obstructive Sleep Apnea (AHI >= 30)"
    ICD10_CODE = "G47.33"
    ...
    @classmethod
    def evaluate_patient_severity(cls, profile: ObstructiveSleepApneaProfile) -> Dict[str, Any]:
