...
ICD-10-CM: I42.1 | SNOMED-CT: 233873004 | Specialty: Cardiology
...
@dataclass
class HypertrophicCardiomyopathyProfile:
...
class HypertrophicCardiomyopathyOntology:
    """
    Structured Pathophysiological & Evidence-Based Knowledge Base for Hypertrophic Obstructive Cardiomyopathy (HOCM).
    """

    DISEASE_NAME = "Hypertrophic Obstructive Cardiomyopathy (HOCM)"
    ICD10_CODE = "I42.1"
    SNOMED_CODE = "233873004"
    ...
    @classmethod
    def evaluate_patient_severity(cls, profile: HypertrophicCardiomyopathyProfile) -> Dict[str, Any]:
