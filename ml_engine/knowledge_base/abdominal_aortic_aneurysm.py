...
ICD-10-CM: I71.4 | SNOMED-CT: 233985008 | Specialty: Vascular Surgery
...
@dataclass
class AbdominalAorticAneurysmProfile:
...
class AbdominalAorticAneurysmOntology:
    """
    Structured Pathophysiological & Evidence-Based Knowledge Base for Abdominal Aortic Aneurysm without Rupture.
    """

    DISEASE_NAME = "Abdominal Aortic Aneurysm without Rupture"
    ICD10_CODE = "I71.4"
    ...
    @classmethod
    def evaluate_patient_severity(cls, profile: AbdominalAorticAneurysmProfile) -> Dict[str, Any]:
