...
ICD-10-CM: I42.0 | SNOMED-CT: 2858002 | Specialty: Cardiology
...
@dataclass
class DilatedCardiomyopathyProfile:
...
class DilatedCardiomyopathyOntology:
    """
    Structured Pathophysiological & Evidence-Based Knowledge Base for Idiopathic Dilated Cardiomyopathy (DCM).
    """

    DISEASE_NAME = "Idiopathic Dilated Cardiomyopathy (DCM)"
    ICD10_CODE = "I42.0"
    SNOMED_CODE = "2858002"
    ...
    @classmethod
    def evaluate_patient_severity(cls, profile: DilatedCardiomyopathyProfile) -> Dict[str, Any]:
