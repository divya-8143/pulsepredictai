...
ICD-10-CM: E24.9 | SNOMED-CT: 237787005 | Specialty: Endocrinology
...
class CushingSyndromeOntology:
    """
    Structured Pathophysiological & Evidence-Based Knowledge Base for Endogenous Hypercortisolemia & Cushing Syndrome.
    """

    DISEASE_NAME = "Endogenous Hypercortisolemia & Cushing Syndrome"
    ICD10_CODE = "E24.9"
    SNOMED_CODE = "237787005"
    ...
    @classmethod
    def evaluate_patient_severity(cls, profile: CushingSyndromeProfile) -> Dict[str, Any]:
