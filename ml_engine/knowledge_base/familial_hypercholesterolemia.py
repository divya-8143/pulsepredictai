...
ICD-10-CM: E78.01 | SNOMED-CT: 238072004 | Specialty: Lipidology
...
@dataclass
class FamilialHypercholesterolemiaProfile:
...
class FamilialHypercholesterolemiaOntology:
    """
    Structured Pathophysiological & Evidence-Based Knowledge Base for Heterozygous Familial Hypercholesterolemia (HeFH).
    """

    DISEASE_NAME = "Heterozygous Familial Hypercholesterolemia (HeFH)"
    ICD10_CODE = "E78.01"
    SNOMED_CODE = "238072004"
    ...
    @classmethod
    def evaluate_patient_severity(cls, profile: FamilialHypercholesterolemiaProfile) -> Dict[str, Any]:
