...
ICD-10-CM: I65.29 | SNOMED-CT: 64586002 | Specialty: Vascular
...
@dataclass
class CarotidArteryStenosisProfile:
...
class CarotidArteryStenosisOntology:
    """
    Structured Pathophysiological & Evidence-Based Knowledge Base for Carotid Artery Atherosclerotic Stenosis.
    """

    DISEASE_NAME = "Carotid Artery Atherosclerotic Stenosis"
    ICD10_CODE = "I65.29"
    SNOMED_CODE = "64586002"
    SPECIALTY = "Vascular"
    ...
    @classmethod
    def evaluate_patient_severity(cls, profile: CarotidArteryStenosisProfile) -> Dict[str, Any]:
