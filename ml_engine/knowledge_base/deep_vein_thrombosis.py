...
ICD-10-CM: I82.40 | SNOMED-CT: 128053003 | Specialty: Hematology
...
@dataclass
class DeepVeinThrombosisProfile:
...
class DeepVeinThrombosisOntology:
    """
    Structured Pathophysiological & Evidence-Based Knowledge Base for Acute Deep Vein Thrombosis of Lower Extremity.
    """

    DISEASE_NAME = "Acute Deep Vein Thrombosis of Lower Extremity"
    ICD10_CODE = "I82.40"
    ...
    @classmethod
    def evaluate_patient_severity(cls, profile: DeepVeinThrombosisProfile) -> Dict[str, Any]:
