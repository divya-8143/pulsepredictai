...
ICD-10-CM: I50.32 | SNOMED-CT: 446221000 | Specialty: Cardiology
...
@dataclass
class HeartFailurePreservedEfProfile:
...
class HeartFailurePreservedEfOntology:
    """
    Structured Pathophysiological & Evidence-Based Knowledge Base for Heart Failure with Preserved Ejection Fraction (HFpEF).
    """

    DISEASE_NAME = "Heart Failure with Preserved Ejection Fraction (HFpEF)"
    ICD10_CODE = "I50.32"
    SNOMED_CODE = "446221000"
    ...
    @classmethod
    def evaluate_patient_severity(cls, profile: HeartFailurePreservedEfProfile) -> Dict[str, Any]:
