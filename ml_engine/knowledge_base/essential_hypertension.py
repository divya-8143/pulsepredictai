...
ICD-10-CM: I10 | SNOMED-CT: 59621000 | Specialty: Cardiology
...
@dataclass
class EssentialHypertensionProfile:
...
class EssentialHypertensionOntology:
    """
    Structured Pathophysiological & Evidence-Based Knowledge Base for Essential (Primary) Hypertension.
    """
    ...
    @classmethod
    def evaluate_patient_severity(cls, profile: EssentialHypertensionProfile) -> Dict[str, Any]:
