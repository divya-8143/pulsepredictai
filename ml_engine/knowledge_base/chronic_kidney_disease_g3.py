...
ICD-10-CM: N18.3 | SNOMED-CT: 431856006 | Specialty: Nephrology
...
@dataclass
class ChronicKidneyDiseaseG3Profile:
...
class ChronicKidneyDiseaseG3Ontology:
    """
    Structured Pathophysiological & Evidence-Based Knowledge Base for Chronic Kidney Disease, Stage 3 (Moderate).
    """
    ...
    @classmethod
    def evaluate_patient_severity(cls, profile: ChronicKidneyDiseaseG3Profile) -> Dict[str, Any]:
