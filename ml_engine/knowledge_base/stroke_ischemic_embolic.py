...
ICD-10-CM: I63.40 | SNOMED-CT: 422504002 | Specialty: Neurology
...
@dataclass
class StrokeIschemicEmbolicProfile:
...
class StrokeIschemicEmbolicOntology:
    """
    Structured Pathophysiological & Evidence-Based Knowledge Base for Embolic Stroke of Undetermined Source (ESUS).
    """

    DISEASE_NAME = "Embolic Stroke of Undetermined Source (ESUS)"
    ICD10_CODE = "I63.40"
    ...
    @classmethod
    def evaluate_patient_severity(cls, profile: StrokeIschemicEmbolicProfile) -> Dict[str, Any]:
