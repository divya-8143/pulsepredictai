"""
BAP-65 Severity Score for Acute Exacerbation of COPD
Clinical Reference: Tabak et al. Arch Intern Med. 2009;169(21):1995-2002
...
class BAP_65Engine:
    """
    Implementation of BAP-65 Severity Score for Acute Exacerbation of COPD.
    Tabak et al. Arch Intern Med. 2009;169(21):1995-2002
    """

    MODEL_NAME = "BAP-65 Severity Score for Acute Exacerbation of COPD"
    CATEGORY = "Pulmonology"
    REFERENCE = "Tabak et al. Arch Intern Med. 2009;169(21):1995-2002"

    @classmethod
    def evaluate(cls, inp: BAP_65Input) -> Dict[str, Any]:
        """
    ...
    @classmethod
    def _calculate_raw_score(cls, inp: BAP_65Input, is_male: bool, is_smoker: bool) -> float:
        score = 0.0
        # Age contribution
    ...
    @classmethod
    def _derive_risk_probability(cls, raw_score: float, inp: BAP_65Input, is_male: bool) -> float:
    ...
    @staticmethod
    def _generate_clinical_interpretation(tier: str, pct: float, inp: BAP_65Input) -> str:
    ...
    @staticmethod
    def _get_guideline_recommendations(tier: str, inp: BAP_65Input) -> List[Dict[str, str]]:
        actions = []
    ...
    @staticmethod
    def _calculate_sub_indices(inp: BAP_65Input) -> Dict[str, float]:
