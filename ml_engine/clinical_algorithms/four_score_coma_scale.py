"""
Full Outline of UnResponsiveness (FOUR) Neurological Score
Specialty: Neurology
...
class FourScoreComaScaleCalculator:
    """
    Precision calculator implementation for Full Outline of UnResponsiveness (FOUR) Neurological Score.
    """

    TITLE = "Full Outline of UnResponsiveness (FOUR) Neurological Score"
    SPECIALTY = "Neurology"
