...
Clinical Reference: Pisters et al. Chest. 2010;138(5):1093-1100
Category: Cardiology
...
class HAS_BLEDEngine:
    """
    Implementation of HAS-BLED Score for Major Bleeding Risk in Atrial Fibrillation.
    Pisters et al. Chest. 2010;138(5):1093-1100
    """

    MODEL_NAME = "HAS-BLED Score for Major Bleeding Risk in Atrial Fibrillation"
    CATEGORY = "Cardiology"
    REFERENCE = "Pisters et al. Chest. 2010;138(5):1093-1100"

    @classmethod
    def evaluate(cls, inp: HAS_BLEDInput) -> Dict[str, Any]:
        """
    ...
    @classmethod
    def _calculate_raw_score(cls, inp: HAS_BLEDInput, is_male: bool, is_smoker: bool) -> float:
        score = 0.0
        # Age contribution
    ...
    @classmethod
    def _derive_risk_probability(cls, raw_score: float, inp: HAS_BLEDInput, is_male: bool) -> float:
    ...
    @staticmethod
    def _generate_clinical_interpretation(tier: str, pct: float, inp: HAS_BLEDInput) -> str:
    ...
    @staticmethod
    def _get_guideline_recommendations(tier: str, inp: HAS_BLEDInput) -> List[Dict[str, str]]:
        actions = []
    ...
    @staticmethod
    def _calculate_sub_indices(inp: HAS_BLEDInput) -> Dict[str, float]:
