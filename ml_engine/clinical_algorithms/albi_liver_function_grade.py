"""
Albumin-Bilirubin (ALBI) Grade for Hepatocellular Function
...
class AlbiLiverFunctionGradeCalculator:
    """
    Precision calculator implementation for Albumin-Bilirubin (ALBI) Grade for Hepatocellular Function.
    """

    TITLE = "Albumin-Bilirubin (ALBI) Grade for Hepatocellular Function"
    SPECIALTY = "Hepatology"
