...
Clinical Reference: Knaus et al. Crit Care Med. 1985;13(10):818-829
...
class APACHE_IIEngine:
    """
    Implementation of APACHE II Severity of Disease Classification System.
    Knaus et al. Crit Care Med. 1985;13(10):818-829
    """

    MODEL_NAME = "APACHE II Severity of Disease Classification System"
    CATEGORY = "Critical Care"
    REFERENCE = "Knaus et al. Crit Care Med. 1985;13(10):818-829"

    @classmethod
    def evaluate(cls, inp: APACHE_IIInput) -> Dict[str, Any]:
        """
    ...
    @classmethod
    def _calculate_raw_score(cls, inp: APACHE_IIInput, is_male: bool, is_smoker: bool) -> float:
        score = 0.0
        # Age contribution
    ...
    @classmethod
    def _derive_risk_probability(cls, raw_score: float, inp: APACHE_IIInput, is_male: bool) -> float:
    ...
    @staticmethod
    def _generate_clinical_interpretation(tier: str, pct: float, inp: APACHE_IIInput) -> str:
    ...
    @staticmethod
    def _get_guideline_recommendations(tier: str, inp: APACHE_IIInput) -> List[Dict[str, str]]:
        actions = []
    ...
    @staticmethod
    def _calculate_sub_indices(inp: APACHE_IIInput) -> Dict[str, float]:
