"""
Centor Criteria (McIsaac Modification) for Group A Strep
...
class CentorStrepPharyngitisCalculator:
    """
    Precision calculator implementation for Centor Criteria (McIsaac Modification) for Group A Strep.
    """

    TITLE = "Centor Criteria (McIsaac Modification) for Group A Strep"
    SPECIALTY = "Infectious Disease"
