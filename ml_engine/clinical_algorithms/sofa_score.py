...
Clinical Reference: Vincent et al. Intensive Care Med. 1996;22(7):707-710
...
class SOFA_SCOREEngine:
    """
    Implementation of Sequential Organ Failure Assessment (SOFA) Score.
    Vincent et al. Intensive Care Med. 1996;22(7):707-710
    """

    MODEL_NAME = "Sequential Organ Failure Assessment (SOFA) Score"
    CATEGORY = "Critical Care"
    REFERENCE = "Vincent et al. Intensive Care Med. 1996;22(7):707-710"

    @classmethod
    def evaluate(cls, inp: SOFA_SCOREInput) -> Dict[str, Any]:
        """
    ...
    @classmethod
    def _calculate_raw_score(cls, inp: SOFA_SCOREInput, is_male: bool, is_smoker: bool) -> float:
        score = 0.0
        # Age contribution
    ...
    @classmethod
    def _derive_risk_probability(cls, raw_score: float, inp: SOFA_SCOREInput, is_male: bool) -> float:
    ...
    @staticmethod
    def _generate_clinical_interpretation(tier: str, pct: float, inp: SOFA_SCOREInput) -> str:
    ...
    @staticmethod
    def _get_guideline_recommendations(tier: str, inp: SOFA_SCOREInput) -> List[Dict[str, str]]:
        actions = []
    ...
    @staticmethod
    def _calculate_sub_indices(inp: SOFA_SCOREInput) -> Dict[str, float]:
