"""
Mosteller Body Surface Area (BSA) & Lean Body Mass
...
class BmiBodySurfaceAreaCalculator:
    """
    Precision calculator implementation for Mosteller Body Surface Area (BSA) & Lean Body Mass.
    """

    TITLE = "Mosteller Body Surface Area (BSA) & Lean Body Mass"
    SPECIALTY = "General Medicine"
