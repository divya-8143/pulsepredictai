"""
CRUSADE In-Hospital Major Bleeding Risk Score
Clinical Reference: Subherwal et al. Circulation. 2009;119(14):1873-1882
Category: Cardiology
...
class CRUSADE_BLEEDEngine:
    """
    Implementation of CRUSADE In-Hospital Major Bleeding Risk Score.
    Subherwal et al. Circulation. 2009;119(14):1873-1882
    """

    MODEL_NAME = "CRUSADE In-Hospital Major Bleeding Risk Score"
    CATEGORY = "Cardiology"
    REFERENCE = "Subherwal et al. Circulation. 2009;119(14):1873-1882"

    @classmethod
    def evaluate(cls, inp: CRUSADE_BLEEDInput) -> Dict[str, Any]:
        """
    ...
    @classmethod
    def _calculate_raw_score(cls, inp: CRUSADE_BLEEDInput, is_male: bool, is_smoker: bool) -> float:
        score = 0.0
        # Age contribution
    ...
    @classmethod
    def _derive_risk_probability(cls, raw_score: float, inp: CRUSADE_BLEEDInput, is_male: bool) -> float:
    ...
    @staticmethod
    def _generate_clinical_interpretation(tier: str, pct: float, inp: CRUSADE_BLEEDInput) -> str:
    ...
    @staticmethod
    def _get_guideline_recommendations(tier: str, inp: CRUSADE_BLEEDInput) -> List[Dict[str, str]]:
        actions = []
    ...
    @staticmethod
    def _calculate_sub_indices(inp: CRUSADE_BLEEDInput) -> Dict[str, float]:
