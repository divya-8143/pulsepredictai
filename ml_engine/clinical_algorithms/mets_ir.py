...
Clinical Reference: Bello-Chavolla et al. J Clin Endocrinol Metab. 2018;103(10):3886-3896
Category: Metabolism
...
class METS_IREngine:
    """
    Implementation of Metabolic Score for Insulin Resistance (METS-IR).
    Bello-Chavolla et al. J Clin Endocrinol Metab. 2018;103(10):3886-3896
    """

    MODEL_NAME = "Metabolic Score for Insulin Resistance (METS-IR)"
    CATEGORY = "Metabolism"
    REFERENCE = "Bello-Chavolla et al. J Clin Endocrinol Metab. 2018;103(10):3886-3896"

    @classmethod
    def evaluate(cls, inp: METS_IRInput) -> Dict[str, Any]:
        """
    ...
    @classmethod
    def _calculate_raw_score(cls, inp: METS_IRInput, is_male: bool, is_smoker: bool) -> float:
        score = 0.0
        # Age contribution
    ...
    @classmethod
    def _derive_risk_probability(cls, raw_score: float, inp: METS_IRInput, is_male: bool) -> float:
    ...
    @staticmethod
    def _generate_clinical_interpretation(tier: str, pct: float, inp: METS_IRInput) -> str:
    ...
    @staticmethod
    def _get_guideline_recommendations(tier: str, inp: METS_IRInput) -> List[Dict[str, str]]:
        actions = []
    ...
    @staticmethod
    def _calculate_sub_indices(inp: METS_IRInput) -> Dict[str, float]:
