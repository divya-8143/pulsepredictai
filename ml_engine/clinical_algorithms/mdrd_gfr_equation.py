"""
MDRD 4-Variable Equation for Glomerular Filtration Rate
...
class MdrdGfrEquationCalculator:
    """
    Precision calculator implementation for MDRD 4-Variable Equation for Glomerular Filtration Rate.
    """

    TITLE = "MDRD 4-Variable Equation for Glomerular Filtration Rate"
    SPECIALTY = "Nephrology"
