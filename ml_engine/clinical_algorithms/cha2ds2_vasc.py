...
Clinical Reference: Lip et al. Chest. 2010;137(2):263-272
Category: Cardiology
...
class CHA2DS2_VAScEngine:
    """
    Implementation of CHA2DS2-VASc Score for Atrial Fibrillation Stroke Risk.
    Lip et al. Chest. 2010;137(2):263-272
    """

    MODEL_NAME = "CHA2DS2-VASc Score for Atrial Fibrillation Stroke Risk"
    CATEGORY = "Cardiology"
    REFERENCE = "Lip et al. Chest. 2010;137(2):263-272"

    @classmethod
    def evaluate(cls, inp: CHA2DS2_VAScInput) -> Dict[str, Any]:
        """
    ...
    @classmethod
    def _calculate_raw_score(cls, inp: CHA2DS2_VAScInput, is_male: bool, is_smoker: bool) -> float:
        score = 0.0
        # Age contribution
    ...
    @classmethod
    def _derive_risk_probability(cls, raw_score: float, inp: CHA2DS2_VAScInput, is_male: bool) -> float:
    ...
    @staticmethod
    def _generate_clinical_interpretation(tier: str, pct: float, inp: CHA2DS2_VAScInput) -> str:
    ...
    @staticmethod
    def _get_guideline_recommendations(tier: str, inp: CHA2DS2_VAScInput) -> List[Dict[str, str]]:
        actions = []
    ...
    @staticmethod
    def _calculate_sub_indices(inp: CHA2DS2_VAScInput) -> Dict[str, float]:
