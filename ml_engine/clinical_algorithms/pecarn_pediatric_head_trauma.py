"""
PECARN Pediatric Head Injury Clinical Decision Rule
...
class PecarnPediatricHeadTraumaCalculator:
    """
    Precision calculator implementation for PECARN Pediatric Head Injury Clinical Decision Rule.
    """

    TITLE = "PECARN Pediatric Head Injury Clinical Decision Rule"
    SPECIALTY = "Emergency Medicine"
