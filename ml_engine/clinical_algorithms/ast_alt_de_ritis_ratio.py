"""
De Ritis Ratio (AST/ALT) for Hepatic & Alcoholic Injury
...
class AstAltDeRitisRatioCalculator:
    """
    Precision calculator implementation for De Ritis Ratio (AST/ALT) for Hepatic & Alcoholic Injury.
    """

    TITLE = "De Ritis Ratio (AST/ALT) for Hepatic & Alcoholic Injury"
    SPECIALTY = "Hepatology"
