"""
NAFLD Fibrosis Score for Advanced Liver Fibrosis
Clinical Reference: Angulo et al. Hepatology. 2007;45(4):846-854
Category: Hepatology
...
class NAFLD_FSEngine:
    """
    Implementation of NAFLD Fibrosis Score for Advanced Liver Fibrosis.
    Angulo et al. Hepatology. 2007;45(4):846-854
    """

    MODEL_NAME = "NAFLD Fibrosis Score for Advanced Liver Fibrosis"
    CATEGORY = "Hepatology"
    REFERENCE = "Angulo et al. Hepatology. 2007;45(4):846-854"

    @classmethod
    def evaluate(cls, inp: NAFLD_FSInput) -> Dict[str, Any]:
        """
    ...
    @classmethod
    def _calculate_raw_score(cls, inp: NAFLD_FSInput, is_male: bool, is_smoker: bool) -> float:
        score = 0.0
        # Age contribution
    ...
    @classmethod
    def _derive_risk_probability(cls, raw_score: float, inp: NAFLD_FSInput, is_male: bool) -> float:
    ...
    @staticmethod
    def _generate_clinical_interpretation(tier: str, pct: float, inp: NAFLD_FSInput) -> str:
    ...
    @staticmethod
    def _get_guideline_recommendations(tier: str, inp: NAFLD_FSInput) -> List[Dict[str, str]]:
        actions = []
    ...
    @staticmethod
    def _calculate_sub_indices(inp: NAFLD_FSInput) -> Dict[str, float]:
