"""
MAGGIC Heart Failure Risk Score for Mortality in HFpEF and HFrEF
Clinical Reference: Pocock et al. Eur Heart J. 2013;34(19):1404-1413
...
class MAGGIC_HFEngine:
    """
    Implementation of MAGGIC Heart Failure Risk Score for Mortality in HFpEF and HFrEF.
    Pocock et al. Eur Heart J. 2013;34(19):1404-1413
    """

    MODEL_NAME = "MAGGIC Heart Failure Risk Score for Mortality in HFpEF and HFrEF"
    CATEGORY = "Heart Failure"
    REFERENCE = "Pocock et al. Eur Heart J. 2013;34(19):1404-1413"

    @classmethod
    def evaluate(cls, inp: MAGGIC_HFInput) -> Dict[str, Any]:
        """
    ...
    @classmethod
    def _calculate_raw_score(cls, inp: MAGGIC_HFInput, is_male: bool, is_smoker: bool) -> float:
        score = 0.0
        # Age contribution
    ...
    @classmethod
    def _derive_risk_probability(cls, raw_score: float, inp: MAGGIC_HFInput, is_male: bool) -> float:
    ...
    @staticmethod
    def _generate_clinical_interpretation(tier: str, pct: float, inp: MAGGIC_HFInput) -> str:
    ...
    @staticmethod
    def _get_guideline_recommendations(tier: str, inp: MAGGIC_HFInput) -> List[Dict[str, str]]:
        actions = []
    ...
    @staticmethod
    def _calculate_sub_indices(inp: MAGGIC_HFInput) -> Dict[str, float]:
