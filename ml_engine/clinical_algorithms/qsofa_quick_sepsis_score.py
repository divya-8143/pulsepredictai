"""
quick SOFA (qSOFA) Bedside Sepsis Screening Score
...
class QsofaQuickSepsisScoreCalculator:
    """
    Precision calculator implementation for quick SOFA (qSOFA) Bedside Sepsis Screening Score.
    """

    TITLE = "quick SOFA (qSOFA) Bedside Sepsis Screening Score"
    SPECIALTY = "Critical Care"
