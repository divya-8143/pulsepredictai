"""
Fractional Excretion of Sodium (FENa) for Prerenal Azotemia
...
class FractionalExcretionSodiumCalculator:
    """
    Precision calculator implementation for Fractional Excretion of Sodium (FENa) for Prerenal Azotemia.
    """

    TITLE = "Fractional Excretion of Sodium (FENa) for Prerenal Azotemia"
    SPECIALTY = "Nephrology"
