"""
Multi-Ethnic Study of Atherosclerosis (MESA) 10-Year CHD Risk with Agatston CAC
Clinical Reference: McClelland et al. J Am Coll Cardiol. 2015;66(15):1643-1653
...
class MESA_CACEngine:
    """
    Implementation of Multi-Ethnic Study of Atherosclerosis (MESA) 10-Year CHD Risk with Agatston CAC.
    McClelland et al. J Am Coll Cardiol. 2015;66(15):1643-1653
    """

    MODEL_NAME = "Multi-Ethnic Study of Atherosclerosis (MESA) 10-Year CHD Risk with Agatston CAC"
    CATEGORY = "Cardiovascular"
    REFERENCE = "McClelland et al. J Am Coll Cardiol. 2015;66(15):1643-1653"

    @classmethod
    def evaluate(cls, inp: MESA_CACInput) -> Dict[str, Any]:
        """
    ...
    @classmethod
    def _calculate_raw_score(cls, inp: MESA_CACInput, is_male: bool, is_smoker: bool) -> float:
        score = 0.0
        # Age contribution
    ...
    @classmethod
    def _derive_risk_probability(cls, raw_score: float, inp: MESA_CACInput, is_male: bool) -> float:
    ...
    @staticmethod
    def _generate_clinical_interpretation(tier: str, pct: float, inp: MESA_CACInput) -> str:
    ...
    @staticmethod
    def _get_guideline_recommendations(tier: str, inp: MESA_CACInput) -> List[Dict[str, str]]:
        actions = []
    ...
    @staticmethod
    def _calculate_sub_indices(inp: MESA_CACInput) -> Dict[str, float]:
