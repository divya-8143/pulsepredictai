"""
Wells Criteria for Deep Vein Thrombosis (DVT) Probability
Clinical Reference: Wells et al. Lancet. 1997;350(9094):1795-1798
Category: Vascular
...
class WELLS_DVTEngine:
    """
    Implementation of Wells Criteria for Deep Vein Thrombosis (DVT) Probability.
    Wells et al. Lancet. 1997;350(9094):1795-1798
    """

    MODEL_NAME = "Wells Criteria for Deep Vein Thrombosis (DVT) Probability"
    CATEGORY = "Vascular"
    REFERENCE = "Wells et al. Lancet. 1997;350(9094):1795-1798"

    @classmethod
    def evaluate(cls, inp: WELLS_DVTInput) -> Dict[str, Any]:
        """
    ...
    @classmethod
    def _calculate_raw_score(cls, inp: WELLS_DVTInput, is_male: bool, is_smoker: bool) -> float:
        score = 0.0
        # Age contribution
    ...
    @classmethod
    def _derive_risk_probability(cls, raw_score: float, inp: WELLS_DVTInput, is_male: bool) -> float:
    ...
    @staticmethod
    def _generate_clinical_interpretation(tier: str, pct: float, inp: WELLS_DVTInput) -> str:
    ...
    @staticmethod
    def _get_guideline_recommendations(tier: str, inp: WELLS_DVTInput) -> List[Dict[str, str]]:
        actions = []
    ...
    @staticmethod
    def _calculate_sub_indices(inp: WELLS_DVTInput) -> Dict[str, float]:
