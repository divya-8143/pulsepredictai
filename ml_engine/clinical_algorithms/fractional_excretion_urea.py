"""
Fractional Excretion of Urea Nitrogen (FEUrea) on Diuretics
...
class FractionalExcretionUreaCalculator:
    """
    Precision calculator implementation for Fractional Excretion of Urea Nitrogen (FEUrea) on Diuretics.
    """

    TITLE = "Fractional Excretion of Urea Nitrogen (FEUrea) on Diuretics"
    SPECIALTY = "Nephrology"
