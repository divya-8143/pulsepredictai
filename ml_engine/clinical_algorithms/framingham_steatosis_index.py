"""
Framingham Steatosis Index (FSI) for Hepatic Fat Score
...
class FraminghamSteatosisIndexCalculator:
    """
    Precision calculator implementation for Framingham Steatosis Index (FSI) for Hepatic Fat Score.
    """

    TITLE = "Framingham Steatosis Index (FSI) for Hepatic Fat Score"
    SPECIALTY = "Hepatology"
