...
Clinical Reference: Antman et al. JAMA. 2000;284(7):835-842
Category: Cardiology
...
class TIMI_UA_NSTEMIEngine:
    """
    Implementation of TIMI Risk Score for Unstable Angina / NSTEMI.
    Antman et al. JAMA. 2000;284(7):835-842
    """

    MODEL_NAME = "TIMI Risk Score for Unstable Angina / NSTEMI"
    CATEGORY = "Cardiology"
    REFERENCE = "Antman et al. JAMA. 2000;284(7):835-842"

    @classmethod
    def evaluate(cls, inp: TIMI_UA_NSTEMIInput) -> Dict[str, Any]:
        """
    ...
    @classmethod
    def _calculate_raw_score(cls, inp: TIMI_UA_NSTEMIInput, is_male: bool, is_smoker: bool) -> float:
        score = 0.0
        # Age contribution
    ...
    @classmethod
    def _derive_risk_probability(cls, raw_score: float, inp: TIMI_UA_NSTEMIInput, is_male: bool) -> float:
    ...
    @staticmethod
    def _generate_clinical_interpretation(tier: str, pct: float, inp: TIMI_UA_NSTEMIInput) -> str:
    ...
    @staticmethod
    def _get_guideline_recommendations(tier: str, inp: TIMI_UA_NSTEMIInput) -> List[Dict[str, str]]:
        actions = []
    ...
    @staticmethod
    def _calculate_sub_indices(inp: TIMI_UA_NSTEMIInput) -> Dict[str, float]:
