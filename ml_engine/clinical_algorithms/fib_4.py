"""
FIB-4 Index for Non-Invasive Liver Fibrosis Staging
Clinical Reference: Sterling et al. Hepatology. 2006;43(6):1317-1325
Category: Hepatology
...
class FIB_4Engine:
    """
    Implementation of FIB-4 Index for Non-Invasive Liver Fibrosis Staging.
    Sterling et al. Hepatology. 2006;43(6):1317-1325
    """

    MODEL_NAME = "FIB-4 Index for Non-Invasive Liver Fibrosis Staging"
    CATEGORY = "Hepatology"
    REFERENCE = "Sterling et al. Hepatology. 2006;43(6):1317-1325"

    @classmethod
    def evaluate(cls, inp: FIB_4Input) -> Dict[str, Any]:
        """
    ...
    @classmethod
    def _calculate_raw_score(cls, inp: FIB_4Input, is_male: bool, is_smoker: bool) -> float:
        score = 0.0
        # Age contribution
    ...
    @classmethod
    def _derive_risk_probability(cls, raw_score: float, inp: FIB_4Input, is_male: bool) -> float:
    ...
    @staticmethod
    def _generate_clinical_interpretation(tier: str, pct: float, inp: FIB_4Input) -> str:
    ...
    @staticmethod
    def _get_guideline_recommendations(tier: str, inp: FIB_4Input) -> List[Dict[str, str]]:
        actions = []
    ...
    @staticmethod
    def _calculate_sub_indices(inp: FIB_4Input) -> Dict[str, float]:
