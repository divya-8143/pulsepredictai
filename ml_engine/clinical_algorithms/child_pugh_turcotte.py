...
class ChildPughTurcotteCalculator:
    """
    Precision calculator implementation for Child-Pugh Classification for Cirrhosis Severity.
    """

    TITLE = "Child-Pugh Classification for Cirrhosis Severity"
    SPECIALTY = "Hepatology"
