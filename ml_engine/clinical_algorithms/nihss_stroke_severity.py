"""
NIH Stroke Scale (NIHSS) Neurological Deficit Scoring
Specialty: Neurology
...
class NihssStrokeSeverityCalculator:
    """
    Precision calculator implementation for NIH Stroke Scale (NIHSS) Neurological Deficit Scoring.
    """

    TITLE = "NIH Stroke Scale (NIHSS) Neurological Deficit Scoring"
    SPECIALTY = "Neurology"
