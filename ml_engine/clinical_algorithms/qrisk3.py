"""
QRISK3 10-Year Cardiovascular Disease Risk Algorithm
Clinical Reference: Hippisley-Cox et al. BMJ 2017;357:j2099
...
class QRISK3Engine:
    """
    Implementation of QRISK3 10-Year Cardiovascular Disease Risk Algorithm.
    Hippisley-Cox et al. BMJ 2017;357:j2099
    """

    MODEL_NAME = "QRISK3 10-Year Cardiovascular Disease Risk Algorithm"
    CATEGORY = "Cardiovascular"
    REFERENCE = "Hippisley-Cox et al. BMJ 2017;357:j2099"

    @classmethod
    def evaluate(cls, inp: QRISK3Input) -> Dict[str, Any]:
        """
    ...
    @classmethod
    def _calculate_raw_score(cls, inp: QRISK3Input, is_male: bool, is_smoker: bool) -> float:
        score = 0.0
        # Age contribution
    ...
    @classmethod
    def _derive_risk_probability(cls, raw_score: float, inp: QRISK3Input, is_male: bool) -> float:
    ...
    @staticmethod
    def _generate_clinical_interpretation(tier: str, pct: float, inp: QRISK3Input) -> str:
    ...
    @staticmethod
    def _get_guideline_recommendations(tier: str, inp: QRISK3Input) -> List[Dict[str, str]]:
        actions = []
    ...
    @staticmethod
    def _calculate_sub_indices(inp: QRISK3Input) -> Dict[str, float]:
