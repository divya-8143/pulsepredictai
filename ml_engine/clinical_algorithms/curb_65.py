...
Clinical Reference: Lim et al. Thorax. 2003;58(5):377-382
...
class CURB_65Engine:
    """
    Implementation of CURB-65 Severity Score for Community-Acquired Pneumonia.
    Lim et al. Thorax. 2003;58(5):377-382
    """

    MODEL_NAME = "CURB-65 Severity Score for Community-Acquired Pneumonia"
    CATEGORY = "Pulmonology"
    REFERENCE = "Lim et al. Thorax. 2003;58(5):377-382"

    @classmethod
    def evaluate(cls, inp: CURB_65Input) -> Dict[str, Any]:
        """
    ...
    @classmethod
    def _calculate_raw_score(cls, inp: CURB_65Input, is_male: bool, is_smoker: bool) -> float:
        score = 0.0
        # Age contribution
    ...
    @classmethod
    def _derive_risk_probability(cls, raw_score: float, inp: CURB_65Input, is_male: bool) -> float:
    ...
    @staticmethod
    def _generate_clinical_interpretation(tier: str, pct: float, inp: CURB_65Input) -> str:
    ...
    @staticmethod
    def _get_guideline_recommendations(tier: str, inp: CURB_65Input) -> List[Dict[str, str]]:
        actions = []
    ...
    @staticmethod
    def _calculate_sub_indices(inp: CURB_65Input) -> Dict[str, float]:
