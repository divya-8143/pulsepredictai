...
Clinical Reference: Shapiro et al. Crit Care Med. 2003;31(3):670-675
...
class MEDS_RISKEngine:
    """
    Implementation of Mortality in Emergency Department Sepsis (MEDS) Score.
    Shapiro et al. Crit Care Med. 2003;31(3):670-675
    """

    MODEL_NAME = "Mortality in Emergency Department Sepsis (MEDS) Score"
    CATEGORY = "Critical Care"
    REFERENCE = "Shapiro et al. Crit Care Med. 2003;31(3):670-675"

    @classmethod
    def evaluate(cls, inp: MEDS_RISKInput) -> Dict[str, Any]:
        """
    ...
    @classmethod
    def _calculate_raw_score(cls, inp: MEDS_RISKInput, is_male: bool, is_smoker: bool) -> float:
        score = 0.0
        # Age contribution
    ...
    @classmethod
    def _derive_risk_probability(cls, raw_score: float, inp: MEDS_RISKInput, is_male: bool) -> float:
    ...
    @staticmethod
    def _generate_clinical_interpretation(tier: str, pct: float, inp: MEDS_RISKInput) -> str:
    ...
    @staticmethod
    def _get_guideline_recommendations(tier: str, inp: MEDS_RISKInput) -> List[Dict[str, str]]:
        actions = []
    ...
    @staticmethod
    def _calculate_sub_indices(inp: MEDS_RISKInput) -> Dict[str, float]:
