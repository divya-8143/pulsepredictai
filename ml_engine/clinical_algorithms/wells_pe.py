...
Clinical Reference: Wells et al. Ann Intern Med. 2001;135(2):98-107
Category: Vascular
...
class WELLS_PEEngine:
    """
    Implementation of Wells Criteria for Pulmonary Embolism (PE) Clinical Probability.
    Wells et al. Ann Intern Med. 2001;135(2):98-107
    """

    MODEL_NAME = "Wells Criteria for Pulmonary Embolism (PE) Clinical Probability"
    CATEGORY = "Vascular"
    REFERENCE = "Wells et al. Ann Intern Med. 2001;135(2):98-107"

    @classmethod
    def evaluate(cls, inp: WELLS_PEInput) -> Dict[str, Any]:
        """
    ...
    @classmethod
    def _calculate_raw_score(cls, inp: WELLS_PEInput, is_male: bool, is_smoker: bool) -> float:
        score = 0.0
        # Age contribution
    ...
    @classmethod
    def _derive_risk_probability(cls, raw_score: float, inp: WELLS_PEInput, is_male: bool) -> float:
    ...
    @staticmethod
    def _generate_clinical_interpretation(tier: str, pct: float, inp: WELLS_PEInput) -> str:
    ...
    @staticmethod
    def _get_guideline_recommendations(tier: str, inp: WELLS_PEInput) -> List[Dict[str, str]]:
        actions = []
    ...
    @staticmethod
    def _calculate_sub_indices(inp: WELLS_PEInput) -> Dict[str, float]:
