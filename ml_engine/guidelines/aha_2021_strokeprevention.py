...
Reference: Kleindorfer et al. Stroke. 2021;52(7):e364-e467
Domain: Neurology
...
@dataclass
class AHA_2021_StrokePreventionPatientContext:
    age: float
    gender: str
    systolic_bp: float
    diastolic_bp: float
...
class AHA_2021_StrokePreventionGuidelineEngine:
    """
    Automated Clinical Decision Support Rule Engine for 2021 Guideline for the Prevention of Stroke in Patients With Stroke and Transient Ischemic Attack.
    """

    GUIDELINE_ID = "AHA_2021_StrokePrevention"
    TITLE = "2021 Guideline for the Prevention of Stroke in Patients With Stroke and Transient Ischemic Attack"
    CITATION = "Kleindorfer et al. Stroke. 2021;52(7):e364-e467"
    DOMAIN = "Neurology"

    @classmethod
    def evaluate_compliance_and_actions(cls, ctx: AHA_2021_StrokePreventionPatientContext) -> Dict[str, Any]:
        """
    ...
    @classmethod
    def _evaluate_lipid_statin_pathway(cls, ctx: AHA_2021_StrokePreventionPatientContext) -> Dict[str, Any]:
    ...
    @classmethod
    def _evaluate_blood_pressure_pathway(cls, ctx: AHA_2021_StrokePreventionPatientContext) -> Dict[str, Any]:
    ...
    @classmethod
    def _evaluate_metabolic_pathway(cls, ctx: AHA_2021_StrokePreventionPatientContext) -> Optional[Dict[str, Any]]:
    ...
    @classmethod
    def _evaluate_antiplatelet_pathway(cls, ctx: AHA_2021_StrokePreventionPatientContext) -> Dict[str, Any]:
        if ctx.known_ascvd:
            return {
    ...
    @classmethod
    def _evaluate_lifestyle_standards(cls, ctx: AHA_2021_StrokePreventionPatientContext) -> Dict[str, Any]:
        return {
    ...
    @staticmethod
    def _calculate_guideline_adherence(ctx: AHA_2021_StrokePreventionPatientContext, recs: List[Dict[str, Any]]) -> float:
        score = 85.0
    ...
    @staticmethod
    def _build_evidence_summary(ctx: AHA_2021_StrokePreventionPatientContext) -> str:
        return (
            f"Evidence evaluation synthesized across 2021 Guideline for the Prevention of Stroke in Patients With Stroke and Transient Ischemic Attack. "
