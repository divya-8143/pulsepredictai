...
Reference: National Institute for Health and Care Excellence. 2019 (Updated 2023)
...
@dataclass
class NICE_NG136_HTNPatientContext:
    age: float
    gender: str
    systolic_bp: float
    diastolic_bp: float
...
class NICE_NG136_HTNGuidelineEngine:
    """
    Automated Clinical Decision Support Rule Engine for NICE Guideline [NG136]: Hypertension in Adults: Diagnosis and Management.
    """

    GUIDELINE_ID = "NICE_NG136_HTN"
    TITLE = "NICE Guideline [NG136]: Hypertension in Adults: Diagnosis and Management"
    CITATION = "National Institute for Health and Care Excellence. 2019 (Updated 2023)"
    DOMAIN = "Cardiovascular"

    @classmethod
    def evaluate_compliance_and_actions(cls, ctx: NICE_NG136_HTNPatientContext) -> Dict[str, Any]:
        """
    ...
    @classmethod
    def _evaluate_lipid_statin_pathway(cls, ctx: NICE_NG136_HTNPatientContext) -> Dict[str, Any]:
    ...
    @classmethod
    def _evaluate_blood_pressure_pathway(cls, ctx: NICE_NG136_HTNPatientContext) -> Dict[str, Any]:
    ...
    @classmethod
    def _evaluate_metabolic_pathway(cls, ctx: NICE_NG136_HTNPatientContext) -> Optional[Dict[str, Any]]:
    ...
    @classmethod
    def _evaluate_antiplatelet_pathway(cls, ctx: NICE_NG136_HTNPatientContext) -> Dict[str, Any]:
        if ctx.known_ascvd:
            return {
    ...
    @classmethod
    def _evaluate_lifestyle_standards(cls, ctx: NICE_NG136_HTNPatientContext) -> Dict[str, Any]:
        return {
    ...
    @staticmethod
    def _calculate_guideline_adherence(ctx: NICE_NG136_HTNPatientContext, recs: List[Dict[str, Any]]) -> float:
        score = 85.0
    ...
    @staticmethod
    def _build_evidence_summary(ctx: NICE_NG136_HTNPatientContext) -> str:
        return (
            f"Evidence evaluation synthesized across NICE Guideline [NG136]: Hypertension in Adults: Diagnosis and Management. "
