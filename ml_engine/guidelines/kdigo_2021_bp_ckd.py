...
Reference: Cheung et al. Kidney Int. 2021;99(3S):S1-S87
Domain: Nephrology
...
@dataclass
class KDIGO_2021_BP_CKDPatientContext:
    age: float
    gender: str
    systolic_bp: float
    diastolic_bp: float
...
class KDIGO_2021_BP_CKDGuidelineEngine:
    """
    Automated Clinical Decision Support Rule Engine for KDIGO 2021 Clinical Practice Guideline for the Management of Blood Pressure in Chronic Kidney Disease.
    """

    GUIDELINE_ID = "KDIGO_2021_BP_CKD"
    TITLE = "KDIGO 2021 Clinical Practice Guideline for the Management of Blood Pressure in Chronic Kidney Disease"
    CITATION = "Cheung et al. Kidney Int. 2021;99(3S):S1-S87"
    DOMAIN = "Nephrology"

    @classmethod
    def evaluate_compliance_and_actions(cls, ctx: KDIGO_2021_BP_CKDPatientContext) -> Dict[str, Any]:
        """
    ...
    @classmethod
    def _evaluate_lipid_statin_pathway(cls, ctx: KDIGO_2021_BP_CKDPatientContext) -> Dict[str, Any]:
    ...
    @classmethod
    def _evaluate_blood_pressure_pathway(cls, ctx: KDIGO_2021_BP_CKDPatientContext) -> Dict[str, Any]:
    ...
    @classmethod
    def _evaluate_metabolic_pathway(cls, ctx: KDIGO_2021_BP_CKDPatientContext) -> Optional[Dict[str, Any]]:
    ...
    @classmethod
    def _evaluate_antiplatelet_pathway(cls, ctx: KDIGO_2021_BP_CKDPatientContext) -> Dict[str, Any]:
        if ctx.known_ascvd:
            return {
    ...
    @classmethod
    def _evaluate_lifestyle_standards(cls, ctx: KDIGO_2021_BP_CKDPatientContext) -> Dict[str, Any]:
        return {
    ...
    @staticmethod
    def _calculate_guideline_adherence(ctx: KDIGO_2021_BP_CKDPatientContext, recs: List[Dict[str, Any]]) -> float:
        score = 85.0
    ...
    @staticmethod
    def _build_evidence_summary(ctx: KDIGO_2021_BP_CKDPatientContext) -> str:
        return (
            f"Evidence evaluation synthesized across KDIGO 2021 Clinical Practice Guideline for the Management of Blood Pressure in Chronic Kidney Disease. "
