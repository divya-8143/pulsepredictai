...
Reference: Visseren et al. Eur Heart J. 2021;42(34):3227-3337
...
@dataclass
class ESC_2021_CVDPatientContext:
    age: float
    gender: str
    systolic_bp: float
    diastolic_bp: float
...
class ESC_2021_CVDGuidelineEngine:
    """
    Automated Clinical Decision Support Rule Engine for 2021 ESC Guidelines on Cardiovascular Disease Prevention in Clinical Practice.
    """

    GUIDELINE_ID = "ESC_2021_CVD"
    TITLE = "2021 ESC Guidelines on Cardiovascular Disease Prevention in Clinical Practice"
    CITATION = "Visseren et al. Eur Heart J. 2021;42(34):3227-3337"
    DOMAIN = "Cardiovascular"

    @classmethod
    def evaluate_compliance_and_actions(cls, ctx: ESC_2021_CVDPatientContext) -> Dict[str, Any]:
        """
    ...
    @classmethod
    def _evaluate_lipid_statin_pathway(cls, ctx: ESC_2021_CVDPatientContext) -> Dict[str, Any]:
    ...
    @classmethod
    def _evaluate_blood_pressure_pathway(cls, ctx: ESC_2021_CVDPatientContext) -> Dict[str, Any]:
    ...
    @classmethod
    def _evaluate_metabolic_pathway(cls, ctx: ESC_2021_CVDPatientContext) -> Optional[Dict[str, Any]]:
    ...
    @classmethod
    def _evaluate_antiplatelet_pathway(cls, ctx: ESC_2021_CVDPatientContext) -> Dict[str, Any]:
        if ctx.known_ascvd:
            return {
    ...
    @classmethod
    def _evaluate_lifestyle_standards(cls, ctx: ESC_2021_CVDPatientContext) -> Dict[str, Any]:
        return {
    ...
    @staticmethod
    def _calculate_guideline_adherence(ctx: ESC_2021_CVDPatientContext, recs: List[Dict[str, Any]]) -> float:
        score = 85.0
    ...
    @staticmethod
    def _build_evidence_summary(ctx: ESC_2021_CVDPatientContext) -> str:
        return (
            f"Evidence evaluation synthesized across 2021 ESC Guidelines on Cardiovascular Disease Prevention in Clinical Practice. "
