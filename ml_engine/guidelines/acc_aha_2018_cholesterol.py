...
Reference: Grundy et al. Circulation. 2019;139(25):e1082-e1143
Domain: Lipidology
...
@dataclass
class ACC_AHA_2018_CholesterolPatientContext:
    age: float
    gender: str
    systolic_bp: float
    diastolic_bp: float
...
class ACC_AHA_2018_CholesterolGuidelineEngine:
    """
    Automated Clinical Decision Support Rule Engine for 2018 AHA/ACC/AACVPR/AAPA/ABC/ACPM/ADA/AGS/APhA/ASPC/NLA/PCNA Guideline on the Management of Blood Cholesterol.
    """

    GUIDELINE_ID = "ACC_AHA_2018_Cholesterol"
    TITLE = "2018 AHA/ACC/AACVPR/AAPA/ABC/ACPM/ADA/AGS/APhA/ASPC/NLA/PCNA Guideline on the Management of Blood Cholesterol"
    CITATION = "Grundy et al. Circulation. 2019;139(25):e1082-e1143"
    DOMAIN = "Lipidology"

    @classmethod
    def evaluate_compliance_and_actions(cls, ctx: ACC_AHA_2018_CholesterolPatientContext) -> Dict[str, Any]:
        """
    ...
    @classmethod
    def _evaluate_lipid_statin_pathway(cls, ctx: ACC_AHA_2018_CholesterolPatientContext) -> Dict[str, Any]:
    ...
    @classmethod
    def _evaluate_blood_pressure_pathway(cls, ctx: ACC_AHA_2018_CholesterolPatientContext) -> Dict[str, Any]:
    ...
    @classmethod
    def _evaluate_metabolic_pathway(cls, ctx: ACC_AHA_2018_CholesterolPatientContext) -> Optional[Dict[str, Any]]:
    ...
    @classmethod
    def _evaluate_antiplatelet_pathway(cls, ctx: ACC_AHA_2018_CholesterolPatientContext) -> Dict[str, Any]:
        if ctx.known_ascvd:
            return {
    ...
    @classmethod
    def _evaluate_lifestyle_standards(cls, ctx: ACC_AHA_2018_CholesterolPatientContext) -> Dict[str, Any]:
        return {
    ...
    @staticmethod
    def _calculate_guideline_adherence(ctx: ACC_AHA_2018_CholesterolPatientContext, recs: List[Dict[str, Any]]) -> float:
        score = 85.0
    ...
    @staticmethod
    def _build_evidence_summary(ctx: ACC_AHA_2018_CholesterolPatientContext) -> str:
        return (
            f"Evidence evaluation synthesized across 2018 AHA/ACC/AACVPR/AAPA/ABC/ACPM/ADA/AGS/APhA/ASPC/NLA/PCNA Guideline on the Management of Blood Cholesterol. "
