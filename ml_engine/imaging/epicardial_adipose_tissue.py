"""
Epicardial Adipose Tissue (EAT) Thickness & Cardiometabolic Risk
Category: Radiology
...
@dataclass
class EpicardialAdiposeTissueParameters:
...
class EpicardialAdiposeTissueCalculator:
    """
    Precision quantification and guideline grading for Epicardial Adipose Tissue (EAT) Thickness & Cardiometabolic Risk.
    """

    EXAM_NAME = "Epicardial Adipose Tissue (EAT) Thickness & Cardiometabolic Risk"
    MODALITY = "Radiology"

    @classmethod
    def calculate_imaging_index(cls, params: EpicardialAdiposeTissueParameters) -> Dict[str, Any]:
        """
