...
@dataclass
class MitralRegurgPisaEroaParameters:
...
class MitralRegurgPisaEroaCalculator:
    """
    Precision quantification and guideline grading for Mitral Regurgitation Effective Regurgitant Orifice Area (EROA).
    """

    EXAM_NAME = "Mitral Regurgitation Effective Regurgitant Orifice Area (EROA)"
    MODALITY = "Echocardiography"

    @classmethod
    def calculate_imaging_index(cls, params: MitralRegurgPisaEroaParameters) -> Dict[str, Any]:
        """
