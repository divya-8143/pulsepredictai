...
@dataclass
class MyocardialPerformanceIndexParameters:
...
class MyocardialPerformanceIndexCalculator:
    """
    Precision quantification and guideline grading for Tei Index / Myocardial Performance Index (MPI).
    """

    EXAM_NAME = "Tei Index / Myocardial Performance Index (MPI)"
    MODALITY = "Echocardiography"

    @classmethod
    def calculate_imaging_index(cls, params: MyocardialPerformanceIndexParameters) -> Dict[str, Any]:
        """
