"""
Doppler Coronary Flow Velocity Reserve (CFVR) Microvascular Index
Category: Cardiology
...
@dataclass
class CoronaryFlowReserveParameters:
...
class CoronaryFlowReserveCalculator:
    """
    Precision quantification and guideline grading for Doppler Coronary Flow Velocity Reserve (CFVR) Microvascular Index.
    """

    EXAM_NAME = "Doppler Coronary Flow Velocity Reserve (CFVR) Microvascular Index"
    MODALITY = "Cardiology"

    @classmethod
    def calculate_imaging_index(cls, params: CoronaryFlowReserveParameters) -> Dict[str, Any]:
        """
