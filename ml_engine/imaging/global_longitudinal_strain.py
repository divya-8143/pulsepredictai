"""
Speckle-Tracking Global Longitudinal Strain (GLS) Subclinical Strain
...
@dataclass
class GlobalLongitudinalStrainParameters:
...
class GlobalLongitudinalStrainCalculator:
    """
    Precision quantification and guideline grading for Speckle-Tracking Global Longitudinal Strain (GLS) Subclinical Strain.
    """

    EXAM_NAME = "Speckle-Tracking Global Longitudinal Strain (GLS) Subclinical Strain"
    MODALITY = "Echocardiography"

    @classmethod
    def calculate_imaging_index(cls, params: GlobalLongitudinalStrainParameters) -> Dict[str, Any]:
        """
