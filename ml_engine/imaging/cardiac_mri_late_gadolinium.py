"""
Cardiac MRI Late Gadolinium Enhancement (LGE) Myocardial Scar
Category: Radiology
...
@dataclass
class CardiacMriLateGadoliniumParameters:
...
class CardiacMriLateGadoliniumCalculator:
    """
    Precision quantification and guideline grading for Cardiac MRI Late Gadolinium Enhancement (LGE) Myocardial Scar.
    """

    EXAM_NAME = "Cardiac MRI Late Gadolinium Enhancement (LGE) Myocardial Scar"
    MODALITY = "Radiology"

    @classmethod
    def calculate_imaging_index(cls, params: CardiacMriLateGadoliniumParameters) -> Dict[str, Any]:
        """
