"""
Nuclear SPECT Myocardial Perfusion Total Perfusion Deficit (TPD)
...
@dataclass
class NuclearSpectMyocardialPerfusionParameters:
...
class NuclearSpectMyocardialPerfusionCalculator:
    """
    Precision quantification and guideline grading for Nuclear SPECT Myocardial Perfusion Total Perfusion Deficit (TPD).
    """

    EXAM_NAME = "Nuclear SPECT Myocardial Perfusion Total Perfusion Deficit (TPD)"
    MODALITY = "Nuclear Cardiology"

    @classmethod
    def calculate_imaging_index(cls, params: NuclearSpectMyocardialPerfusionParameters) -> Dict[str, Any]:
        """
