"""
Cardiac MRI T1 Mapping & Extracellular Volume Fraction (ECV)
Category: Radiology
...
@dataclass
class CardiacMriEcvFractionParameters:
...
class CardiacMriEcvFractionCalculator:
    """
    Precision quantification and guideline grading for Cardiac MRI T1 Mapping & Extracellular Volume Fraction (ECV).
    """

    EXAM_NAME = "Cardiac MRI T1 Mapping & Extracellular Volume Fraction (ECV)"
    MODALITY = "Radiology"

    @classmethod
    def calculate_imaging_index(cls, params: CardiacMriEcvFractionParameters) -> Dict[str, Any]:
        """
