"""
Ankle-Brachial Index (ABI) Doppler Occlusive Disease
Category: Vascular
...
@dataclass
class AnkleBrachialIndexAbiParameters:
...
class AnkleBrachialIndexAbiCalculator:
    """
    Precision quantification and guideline grading for Ankle-Brachial Index (ABI) Doppler Occlusive Disease.
    """

    EXAM_NAME = "Ankle-Brachial Index (ABI) Doppler Occlusive Disease"
    MODALITY = "Vascular"

    @classmethod
    def calculate_imaging_index(cls, params: AnkleBrachialIndexAbiParameters) -> Dict[str, Any]:
        """
