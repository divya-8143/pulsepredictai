"""
ASE/EACVI Diastolic Function & E/e' Filling Pressure Grading
...
@dataclass
class DiastolicDysfunctionEeParameters:
...
class DiastolicDysfunctionEeCalculator:
    """
    Precision quantification and guideline grading for ASE/EACVI Diastolic Function & E/e' Filling Pressure Grading.
    """

    EXAM_NAME = "ASE/EACVI Diastolic Function & E/e' Filling Pressure Grading"
    MODALITY = "Echocardiography"

    @classmethod
    def calculate_imaging_index(cls, params: DiastolicDysfunctionEeParameters) -> Dict[str, Any]:
        """
