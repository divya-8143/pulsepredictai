"""
Brachial Artery Flow-Mediated Dilation (FMD) Endothelial Function
Category: Vascular
...
@dataclass
class EndothelialFlowMediatedDilationParameters:
...
class EndothelialFlowMediatedDilationCalculator:
    """
    Precision quantification and guideline grading for Brachial Artery Flow-Mediated Dilation (FMD) Endothelial Function.
    """

    EXAM_NAME = "Brachial Artery Flow-Mediated Dilation (FMD) Endothelial Function"
    MODALITY = "Vascular"

    @classmethod
    def calculate_imaging_index(cls, params: EndothelialFlowMediatedDilationParameters) -> Dict[str, Any]:
        """
