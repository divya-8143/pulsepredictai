...
@dataclass
class TapseRvSystolicParameters:
...
class TapseRvSystolicCalculator:
    """
    Precision quantification and guideline grading for Tricuspid Annular Plane Systolic Excursion (TAPSE).
    """

    EXAM_NAME = "Tricuspid Annular Plane Systolic Excursion (TAPSE)"
    MODALITY = "Echocardiography"

    @classmethod
    def calculate_imaging_index(cls, params: TapseRvSystolicParameters) -> Dict[str, Any]:
        """
