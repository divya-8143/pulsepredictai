...
@dataclass
class RvFractionalAreaChangeParameters:
...
class RvFractionalAreaChangeCalculator:
    """
    Precision quantification and guideline grading for Right Ventricular Fractional Area Change (RV FAC).
    """

    EXAM_NAME = "Right Ventricular Fractional Area Change (RV FAC)"
    MODALITY = "Echocardiography"

    @classmethod
    def calculate_imaging_index(cls, params: RvFractionalAreaChangeParameters) -> Dict[str, Any]:
        """
