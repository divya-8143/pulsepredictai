"""
Carotid Intima-Media Thickness (cIMT) & Subclinical Plaque
Category: Vascular
...
@dataclass
class CarotidIntimaMediaThicknessParameters:
...
class CarotidIntimaMediaThicknessCalculator:
    """
    Precision quantification and guideline grading for Carotid Intima-Media Thickness (cIMT) & Subclinical Plaque.
    """

    EXAM_NAME = "Carotid Intima-Media Thickness (cIMT) & Subclinical Plaque"
    MODALITY = "Vascular"

    @classmethod
    def calculate_imaging_index(cls, params: CarotidIntimaMediaThicknessParameters) -> Dict[str, Any]:
        """
