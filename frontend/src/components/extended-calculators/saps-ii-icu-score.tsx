...
export default function SapsIiIcuScoreWidget() {
    ...
    <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm space-y-4 max-w-2xl mx-auto">
      <div className="flex items-center justify-between border-b pb-3">
        <div>
          ...
          <h3 className="text-base font-bold text-slate-900 mt-1">Simplified Acute Physiology Score (SAPS II)</h3>
          <p className="text-xs text-slate-500">Le Gall et al. JAMA 1993</p>
        </div>
