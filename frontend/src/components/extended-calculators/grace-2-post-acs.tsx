...
export default function Grace2PostAcsWidget() {
    ...
    <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm space-y-4 max-w-2xl mx-auto">
      <div className="flex items-center justify-between border-b pb-3">
        <div>
          ...
          <h3 className="text-base font-bold text-slate-900 mt-1">GRACE 2.0 Acute Coronary Syndrome 6-Month Mortality Model</h3>
          <p className="text-xs text-slate-500">Fox et al. BMJ 2014</p>
        </div>
