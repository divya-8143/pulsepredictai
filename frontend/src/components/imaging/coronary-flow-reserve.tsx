...
export default function CoronaryFlowReserveView() {
    ...
    <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm space-y-4 max-w-2xl mx-auto">
      <div className="flex items-center justify-between border-b pb-3">
        <div>
          ...
          <h3 className="text-base font-bold text-slate-900 mt-1">Doppler Coronary Flow Velocity Reserve (CFVR) Microvascular Index</h3>
        </div>
