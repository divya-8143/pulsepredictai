...
export default function GlobalLongitudinalStrainView() {
    ...
    <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm space-y-4 max-w-2xl mx-auto">
      <div className="flex items-center justify-between border-b pb-3">
        <div>
          ...
          <h3 className="text-base font-bold text-slate-900 mt-1">Speckle-Tracking Global Longitudinal Strain (GLS) Subclinical Strain</h3>
        </div>
