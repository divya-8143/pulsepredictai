...
export default function HeartFailurePreservedEfEncyclopediaView() {
    ...
    <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm space-y-4 max-w-3xl mx-auto">
      <div className="flex items-start justify-between border-b pb-3">
        <div>
          ...
          <h3 className="text-lg font-bold text-slate-900 mt-1.5">Heart Failure with Preserved Ejection Fraction (HFpEF)</h3>
