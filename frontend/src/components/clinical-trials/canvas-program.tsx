...
export default function CanvasProgramCard() {
  return (
    <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm space-y-3">
      <div className="flex items-start justify-between">
        <div>
          ...
          <h3 className="text-base font-bold text-slate-900 mt-1">CANVAS Program: Canagliflozin and Cardiovascular and Renal Events in Type 2 Diabetes</h3>
          <p className="text-xs text-slate-500">Neal et al. N Engl J Med 2017</p>
        </div>
