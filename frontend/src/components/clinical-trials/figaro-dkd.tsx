...
export default function FigaroDkdCard() {
  return (
    <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm space-y-3">
      <div className="flex items-start justify-between">
        <div>
          ...
          <h3 className="text-base font-bold text-slate-900 mt-1">FIGARO-DKD: Cardiovascular Events with Finerenone in Kidney Disease and Diabetes</h3>
          <p className="text-xs text-slate-500">Pitt et al. N Engl J Med 2021</p>
        </div>
