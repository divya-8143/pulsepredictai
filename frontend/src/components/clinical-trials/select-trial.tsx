...
export default function SelectTrialCard() {
  return (
    <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm space-y-3">
      <div className="flex items-start justify-between">
        <div>
          <span className="text-[10px] font-bold uppercase tracking-wider text-emerald-700 bg-emerald-50 px-2 py-0.5 rounded border border-emerald-200">
            Cardiovascular Landmark Trial
          </span>
          <h3 className="text-base font-bold text-slate-900 mt-1">SELECT: Semaglutide and Cardiovascular Outcomes in Obesity without Diabetes</h3>
          <p className="text-xs text-slate-500">Lincoff et al. N Engl J Med 2023</p>
        </div>
