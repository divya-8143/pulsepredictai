...
export default function DeclareTimi58Card() {
  return (
    <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm space-y-3">
      <div className="flex items-start justify-between">
        <div>
          ...
          <h3 className="text-base font-bold text-slate-900 mt-1">DECLARE-TIMI 58: Dapagliflozin and Cardiovascular Outcomes in Type 2 Diabetes</h3>
          <p className="text-xs text-slate-500">Wiviott et al. N Engl J Med 2019</p>
        </div>
