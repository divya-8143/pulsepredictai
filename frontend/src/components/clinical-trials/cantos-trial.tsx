...
export default function CantosTrialCard() {
  return (
    <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm space-y-3">
      <div className="flex items-start justify-between">
        <div>
          ...
          <h3 className="text-base font-bold text-slate-900 mt-1">CANTOS: Antiinflammatory Therapy with Canakinumab for Atherosclerotic Disease</h3>
          <p className="text-xs text-slate-500">Ridker et al. N Engl J Med 2017</p>
        </div>
