...
export default function Step1SemaglutideCard() {
  return (
    <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm space-y-3">
      <div className="flex items-start justify-between">
        <div>
          <span className="text-[10px] font-bold uppercase tracking-wider text-emerald-700 bg-emerald-50 px-2 py-0.5 rounded border border-emerald-200">
            Metabolism Landmark Trial
          </span>
          <h3 className="text-base font-bold text-slate-900 mt-1">STEP 1: Once-Weekly Semaglutide in Adults with Overweight or Obesity</h3>
          <p className="text-xs text-slate-500">Wilding et al. N Engl J Med 2021</p>
        </div>
