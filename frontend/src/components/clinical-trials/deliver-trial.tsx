...
export default function DeliverTrialCard() {
  return (
    <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm space-y-3">
      <div className="flex items-start justify-between">
        <div>
          <span className="text-[10px] font-bold uppercase tracking-wider text-emerald-700 bg-emerald-50 px-2 py-0.5 rounded border border-emerald-200">
            Heart Failure Landmark Trial
          </span>
          <h3 className="text-base font-bold text-slate-900 mt-1">DELIVER: Dapagliflozin in Heart Failure with Mildly Reduced or Preserved Ejection Fraction</h3>
          <p className="text-xs text-slate-500">Solomon et al. N Engl J Med 2022</p>
        </div>
