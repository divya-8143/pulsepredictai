...
export default function CredenceTrialCard() {
  return (
    <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm space-y-3">
      <div className="flex items-start justify-between">
        <div>
          ...
          <h3 className="text-base font-bold text-slate-900 mt-1">CREDENCE: Canagliflozin and Renal Events in Diabetes with Nephropathy</h3>
          <p className="text-xs text-slate-500">Perkovic et al. N Engl J Med 2019</p>
        </div>
