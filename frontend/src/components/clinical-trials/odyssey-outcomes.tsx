...
export default function OdysseyOutcomesCard() {
  return (
    <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm space-y-3">
      <div className="flex items-start justify-between">
        <div>
          ...
          <h3 className="text-base font-bold text-slate-900 mt-1">ODYSSEY OUTCOMES: Alirocumab in Post-ACS Cardiovascular Protection</h3>
          <p className="text-xs text-slate-500">Schwartz et al. N Engl J Med 2018</p>
        </div>
