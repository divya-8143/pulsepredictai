...
export default function ReduceItIpeCard() {
  return (
    <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm space-y-3">
      <div className="flex items-start justify-between">
        <div>
          ...
          <h3 className="text-base font-bold text-slate-900 mt-1">REDUCE-IT: Cardiovascular Risk Reduction with Icosapent Ethyl for Hypertriglyceridemia</h3>
          <p className="text-xs text-slate-500">Bhatt et al. N Engl J Med 2019</p>
        </div>
