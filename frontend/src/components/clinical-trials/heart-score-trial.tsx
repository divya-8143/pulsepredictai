...
export default function HeartScoreTrialCard() {
  return (
    <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm space-y-3">
      <div className="flex items-start justify-between">
        <div>
          <span className="text-[10px] font-bold uppercase tracking-wider text-emerald-700 bg-emerald-50 px-2 py-0.5 rounded border border-emerald-200">
            Emergency Medicine Landmark Trial
          </span>
          <h3 className="text-base font-bold text-slate-900 mt-1">HEART Score Validation for Emergency Department Chest Pain Risk Triage</h3>
          <p className="text-xs text-slate-500">Six et al. Crit Pathw Cardiol 2008</p>
        </div>
