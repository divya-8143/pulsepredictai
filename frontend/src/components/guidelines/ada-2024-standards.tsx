...
export default function ADA_2024_StandardsGuidelineExplorer() {
        ...
        <div className="flex items-start justify-between">
          <div>
            <span className="px-2.5 py-0.5 rounded-full text-xs font-semibold bg-indigo-50 text-indigo-700 border border-indigo-200">
              Diabetes Guideline Core
            </span>
            <h2 className="text-xl font-bold text-slate-900 mt-2">ADA Standards of Care in Diabetes — 2024 Comprehensive Recommendations</h2>
            <p className="text-xs text-slate-500 mt-1">American Diabetes Association. Diabetes Care. 2024;47(Suppl 1):S1-S343</p>
          </div>
