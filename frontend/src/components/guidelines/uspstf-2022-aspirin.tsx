...
export default function USPSTF_2022_AspirinGuidelineExplorer() {
        ...
        <div className="flex items-start justify-between">
          <div>
            <span className="px-2.5 py-0.5 rounded-full text-xs font-semibold bg-indigo-50 text-indigo-700 border border-indigo-200">
              Preventive Medicine Guideline Core
            </span>
            <h2 className="text-xl font-bold text-slate-900 mt-2">USPSTF Recommendation Statement on Aspirin Use to Prevent Cardiovascular Disease</h2>
            <p className="text-xs text-slate-500 mt-1">US Preventive Services Task Force. JAMA. 2022;327(16):1577-1584</p>
          </div>
