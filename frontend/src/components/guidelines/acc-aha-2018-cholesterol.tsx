...
export default function ACC_AHA_2018_CholesterolGuidelineExplorer() {
        ...
        <div className="flex items-start justify-between">
          <div>
            <span className="px-2.5 py-0.5 rounded-full text-xs font-semibold bg-indigo-50 text-indigo-700 border border-indigo-200">
              Lipidology Guideline Core
            </span>
            <h2 className="text-xl font-bold text-slate-900 mt-2">2018 AHA/ACC/AACVPR/AAPA/ABC/ACPM/ADA/AGS/APhA/ASPC/NLA/PCNA Guideline on the Management of Blood Cholesterol</h2>
            <p className="text-xs text-slate-500 mt-1">Grundy et al. Circulation. 2019;139(25):e1082-e1143</p>
          </div>
