...
export default function WHO_PEN_CVDGuidelineExplorer() {
        ...
        <div className="flex items-start justify-between">
          <div>
            <span className="px-2.5 py-0.5 rounded-full text-xs font-semibold bg-indigo-50 text-indigo-700 border border-indigo-200">
              Global Health Guideline Core
            </span>
            <h2 className="text-xl font-bold text-slate-900 mt-2">WHO Package of Essential Noncommunicable Disease Interventions (WHO PEN) for Primary Care</h2>
            <p className="text-xs text-slate-500 mt-1">World Health Organization. 2020 Protocol Guidelines</p>
          </div>
