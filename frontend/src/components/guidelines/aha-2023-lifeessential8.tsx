...
export default function AHA_2023_LifeEssential8GuidelineExplorer() {
        ...
        <div className="flex items-start justify-between">
          <div>
            <span className="px-2.5 py-0.5 rounded-full text-xs font-semibold bg-indigo-50 text-indigo-700 border border-indigo-200">
              Public Health Guideline Core
            </span>
            <h2 className="text-xl font-bold text-slate-900 mt-2">Life's Essential 8: Updating and Enhancing the American Heart Association's Construct of Cardiovascular Health</h2>
            <p className="text-xs text-slate-500 mt-1">Lloyd-Jones et al. Circulation. 2022;146(5):e18-e43</p>
          </div>
