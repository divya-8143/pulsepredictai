...
export default function ENDOCRINE_2022_LIPIDGuidelineExplorer() {
        ...
        <div className="flex items-start justify-between">
          <div>
            <span className="px-2.5 py-0.5 rounded-full text-xs font-semibold bg-indigo-50 text-indigo-700 border border-indigo-200">
              Endocrinology Guideline Core
            </span>
            <h2 className="text-xl font-bold text-slate-900 mt-2">Endocrine Society Clinical Practice Guideline on Lipid Management in Metabolic Disorders</h2>
            <p className="text-xs text-slate-500 mt-1">Rosenblit et al. J Clin Endocrinol Metab. 2022;107(7):1812-1845</p>
          </div>
