...
export default function NICE_NG136_HTNGuidelineExplorer() {
        ...
        <div className="flex items-start justify-between">
          <div>
            <span className="px-2.5 py-0.5 rounded-full text-xs font-semibold bg-indigo-50 text-indigo-700 border border-indigo-200">
              Cardiovascular Guideline Core
            </span>
            <h2 className="text-xl font-bold text-slate-900 mt-2">NICE Guideline [NG136]: Hypertension in Adults: Diagnosis and Management</h2>
            <p className="text-xs text-slate-500 mt-1">National Institute for Health and Care Excellence. 2019 (Updated 2023)</p>
          </div>
