...
export default function ESC_2021_CVDGuidelineExplorer() {
      ...
      <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
        <div className="flex items-start justify-between">
          <div>
            ...
            <h2 className="text-xl font-bold text-slate-900 mt-2">2021 ESC Guidelines on Cardiovascular Disease Prevention in Clinical Practice</h2>
            <p className="text-xs text-slate-500 mt-1">Visseren et al. Eur Heart J. 2021;42(34):3227-3337</p>
          </div>
