...
export default function GOLD_2024_COPDGuidelineExplorer() {
        ...
        <div className="flex items-start justify-between">
          <div>
            <span className="px-2.5 py-0.5 rounded-full text-xs font-semibold bg-indigo-50 text-indigo-700 border border-indigo-200">
              Pulmonology Guideline Core
            </span>
            <h2 className="text-xl font-bold text-slate-900 mt-2">Global Initiative for Chronic Obstructive Lung Disease (GOLD) 2024 Report</h2>
            <p className="text-xs text-slate-500 mt-1">Agusti et al. Am J Respir Crit Care Med. 2024;209(7):793-812</p>
          </div>
