...
export default function KDIGO_2021_BP_CKDGuidelineExplorer() {
      ...
      <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
        <div className="flex items-start justify-between">
          <div>
            ...
            <h2 className="text-xl font-bold text-slate-900 mt-2">KDIGO 2021 Clinical Practice Guideline for the Management of Blood Pressure in Chronic Kidney Disease</h2>
            <p className="text-xs text-slate-500 mt-1">Cheung et al. Kidney Int. 2021;99(3S):S1-S87</p>
          </div>
