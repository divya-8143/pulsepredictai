...
export default function ACC_2022_HeartFailureGuidelineExplorer() {
        ...
        <div className="flex items-start justify-between">
          <div>
            <span className="px-2.5 py-0.5 rounded-full text-xs font-semibold bg-indigo-50 text-indigo-700 border border-indigo-200">
              Heart Failure Guideline Core
            </span>
            <h2 className="text-xl font-bold text-slate-900 mt-2">2022 AHA/ACC/HFSA Guideline for the Management of Heart Failure</h2>
            <p className="text-xs text-slate-500 mt-1">Heidenreich et al. Circulation. 2022;145(18):e895-e1032</p>
          </div>
