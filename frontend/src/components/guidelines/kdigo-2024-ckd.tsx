...
export default function KDIGO_2024_CKDGuidelineExplorer() {
        ...
        <div className="flex items-start justify-between">
          <div>
            <span className="px-2.5 py-0.5 rounded-full text-xs font-semibold bg-indigo-50 text-indigo-700 border border-indigo-200">
              Nephrology Guideline Core
            </span>
            <h2 className="text-xl font-bold text-slate-900 mt-2">KDIGO 2024 Clinical Practice Guideline for the Evaluation and Management of Chronic Kidney Disease</h2>
            <p className="text-xs text-slate-500 mt-1">Kidney Disease: Improving Global Outcomes. Kidney Int. 2024;105(4S):S117-S314</p>
          </div>
