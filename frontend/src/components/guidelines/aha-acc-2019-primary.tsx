...
export default function AHA_ACC_2019_PrimaryGuidelineExplorer() {
      ...
      <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
        <div className="flex items-start justify-between">
          <div>
            ...
            <h2 className="text-xl font-bold text-slate-900 mt-2">2019 ACC/AHA Guideline on the Primary Prevention of Cardiovascular Disease</h2>
            <p className="text-xs text-slate-500 mt-1">Arnett et al. Circulation. 2019;140(11):e596-e646</p>
          </div>
