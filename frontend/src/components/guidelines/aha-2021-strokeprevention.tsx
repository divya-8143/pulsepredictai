...
export default function AHA_2021_StrokePreventionGuidelineExplorer() {
        ...
        <div className="flex items-start justify-between">
          <div>
            <span className="px-2.5 py-0.5 rounded-full text-xs font-semibold bg-indigo-50 text-indigo-700 border border-indigo-200">
              Neurology Guideline Core
            </span>
            <h2 className="text-xl font-bold text-slate-900 mt-2">2021 Guideline for the Prevention of Stroke in Patients With Stroke and Transient Ischemic Attack</h2>
            <p className="text-xs text-slate-500 mt-1">Kleindorfer et al. Stroke. 2021;52(7):e364-e467</p>
          </div>
