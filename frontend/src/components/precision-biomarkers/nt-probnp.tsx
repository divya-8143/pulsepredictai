...
export default function NtProbnpPanel() {
    ...
    <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm space-y-3">
      <div className="flex items-center justify-between border-b pb-2">
        <div>
          ...
          <h3 className="text-sm font-bold text-slate-900 mt-1">N-Terminal Pro-B-Type Natriuretic Peptide (NT-proBNP)</h3>
        </div>
      ...
      <div className="text-xs space-y-2">
        <div className="flex justify-between">
          ...
          <span className="font-semibold text-slate-800">< 125 pg/mL (<75y: <300)</span>
        </div>
      </div>
    </div>
  );
