...
export default function Galectin3Panel() {
    ...
    <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm space-y-3">
      <div className="flex items-center justify-between border-b pb-2">
        <div>
          ...
          <h3 className="text-sm font-bold text-slate-900 mt-1">Galectin-3 Myocardial Fibrosis & Remodeling Marker</h3>
        </div>
      ...
      <div className="text-xs space-y-2">
        <div className="flex justify-between">
          ...
          <span className="font-semibold text-slate-800">< 17.8 ng/mL</span>
        </div>
      </div>
    </div>
  );
