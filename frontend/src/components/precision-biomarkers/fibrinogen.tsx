...
export default function FibrinogenPanel() {
    ...
    <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm space-y-3">
      <div className="flex items-center justify-between border-b pb-2">
        <div>
          ...
          <h3 className="text-sm font-bold text-slate-900 mt-1">Plasma Fibrinogen Clotting & Inflammatory Marker</h3>
        </div>
      ...
      <div className="text-xs space-y-2">
        <div className="flex justify-between">
          ...
          <span className="font-semibold text-slate-800">200 - 400 mg/dL</span>
        </div>
      </div>
    </div>
  );
