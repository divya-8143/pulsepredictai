...
export default function LipoproteinAPanel() {
    ...
    <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm space-y-3">
      <div className="flex items-center justify-between border-b pb-2">
        <div>
          ...
          <h3 className="text-sm font-bold text-slate-900 mt-1">Lipoprotein(a) [Lp(a)] Genetically Determined Particle</h3>
        </div>
      ...
      <div className="text-xs space-y-2">
        <div className="flex justify-between">
          ...
          <span className="font-semibold text-slate-800">< 30 mg/dL (<75 nmol/L)</span>
        </div>
      </div>
    </div>
  );
