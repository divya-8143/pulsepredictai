...
export default function TIMI_UA_NSTEMICalculator({
  initialAge = 52,
  initialGender = "MALE",
  initialSystolic = 135,
  initialDiastolic = 85,
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto p-4">
      <div className="flex items-center justify-between border-b pb-4">
        <div>
          <h2 className="text-2xl font-bold text-slate-900">TIMI Risk Score for Unstable Angina / NSTEMI</h2>
          <p className="text-sm text-slate-500">Antman et al. JAMA. 2000;284(7):835-842</p>
        </div>
