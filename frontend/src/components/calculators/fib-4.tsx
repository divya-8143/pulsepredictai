...
export default function FIB_4Calculator({
  initialAge = 52,
  initialGender = "MALE",
  initialSystolic = 135,
  initialDiastolic = 85,
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto p-4">
      <div className="flex items-center justify-between border-b pb-4">
        <div>
          <h2 className="text-2xl font-bold text-slate-900">FIB-4 Index for Non-Invasive Liver Fibrosis Staging</h2>
          <p className="text-sm text-slate-500">Sterling et al. Hepatology. 2006;43(6):1317-1325</p>
        </div>
