...
export default function SirsSystemicInflammatoryView() {
    ...
    <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm space-y-3 max-w-xl mx-auto">
      <div className="flex items-center justify-between border-b pb-2">
        <div>
          ...
          <h3 className="text-sm font-bold text-slate-900 mt-1">SIRS Criteria for Systemic Inflammatory Response Syndrome</h3>
        </div>
