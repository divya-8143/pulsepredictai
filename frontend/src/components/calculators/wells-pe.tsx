...
export default function WELLS_PECalculator({
  initialAge = 52,
  initialGender = "MALE",
  initialSystolic = 135,
  initialDiastolic = 85,
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto p-4">
      <div className="flex items-center justify-between border-b pb-4">
        <div>
          <h2 className="text-2xl font-bold text-slate-900">Wells Criteria for Pulmonary Embolism (PE) Clinical Probability</h2>
          <p className="text-sm text-slate-500">Wells et al. Ann Intern Med. 2001;135(2):98-107</p>
        </div>
