...
export default function CRUSADE_BLEEDCalculator({
  initialAge = 52,
  initialGender = "MALE",
  initialSystolic = 135,
  initialDiastolic = 85,
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto p-4">
      <div className="flex items-center justify-between border-b pb-4">
        <div>
          <h2 className="text-2xl font-bold text-slate-900">CRUSADE In-Hospital Major Bleeding Risk Score</h2>
          <p className="text-sm text-slate-500">Subherwal et al. Circulation. 2009;119(14):1873-1882</p>
        </div>
