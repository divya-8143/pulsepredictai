...
export default function SEATTLE_HFMCalculator({
  initialAge = 52,
  initialGender = "MALE",
  initialSystolic = 135,
  initialDiastolic = 85,
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto p-4">
      <div className="flex items-center justify-between border-b pb-4">
        <div>
          <h2 className="text-2xl font-bold text-slate-900">Seattle Heart Failure Model for 1-5 Year Survival Prediction</h2>
          <p className="text-sm text-slate-500">Levy et al. Circulation. 2006;113(11):1424-1433</p>
        </div>
