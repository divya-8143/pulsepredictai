...
export default function BAP_65Calculator({
  initialAge = 52,
  initialGender = "MALE",
  initialSystolic = 135,
  initialDiastolic = 85,
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto p-4">
      <div className="flex items-center justify-between border-b pb-4">
        <div>
          <h2 className="text-2xl font-bold text-slate-900">BAP-65 Severity Score for Acute Exacerbation of COPD</h2>
          <p className="text-sm text-slate-500">Tabak et al. Arch Intern Med. 2009;169(21):1995-2002</p>
        </div>
