...
export default function UKPDS_82Calculator({
  initialAge = 52,
  initialGender = "MALE",
  initialSystolic = 135,
  initialDiastolic = 85,
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto p-4">
      <div className="flex items-center justify-between border-b pb-4">
        <div>
          <h2 className="text-2xl font-bold text-slate-900">UK Prospective Diabetes Study (UKPDS 82) Cardiovascular Risk Engine</h2>
          <p className="text-sm text-slate-500">Clarke et al. Diabetologia. 2013;56:2217-2226</p>
        </div>
