...
export default function MEDS_RISKCalculator({
  initialAge = 52,
  initialGender = "MALE",
  initialSystolic = 135,
  initialDiastolic = 85,
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto p-4">
      <div className="flex items-center justify-between border-b pb-4">
        <div>
          <h2 className="text-2xl font-bold text-slate-900">Mortality in Emergency Department Sepsis (MEDS) Score</h2>
          <p className="text-sm text-slate-500">Shapiro et al. Crit Care Med. 2003;31(3):670-675</p>
        </div>
