...
export default function TIMI_STEMICalculator({
  initialAge = 52,
  initialGender = "MALE",
  initialSystolic = 135,
  initialDiastolic = 85,
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto p-4">
      <div className="flex items-center justify-between border-b pb-4">
        <div>
          <h2 className="text-2xl font-bold text-slate-900">TIMI Risk Score for ST-Elevation Myocardial Infarction</h2>
          <p className="text-sm text-slate-500">Morrow et al. Circulation. 2000;102(17):2031-2037</p>
        </div>
