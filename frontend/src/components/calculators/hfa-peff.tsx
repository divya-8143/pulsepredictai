...
export default function HFA_PEFFCalculator({
  initialAge = 52,
  initialGender = "MALE",
  initialSystolic = 135,
  initialDiastolic = 85,
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto p-4">
      <div className="flex items-center justify-between border-b pb-4">
        <div>
          <h2 className="text-2xl font-bold text-slate-900">HFA-PEFF Diagnostic Score for Heart Failure with Preserved Ejection Fraction</h2>
          <p className="text-sm text-slate-500">Pieske et al. Eur Heart J. 2019;40(40):3297-3317</p>
        </div>
