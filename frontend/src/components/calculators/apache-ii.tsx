...
export default function APACHE_IICalculator({
  initialAge = 52,
  initialGender = "MALE",
  initialSystolic = 135,
  initialDiastolic = 85,
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto p-4">
      <div className="flex items-center justify-between border-b pb-4">
        <div>
          <h2 className="text-2xl font-bold text-slate-900">APACHE II Severity of Disease Classification System</h2>
          <p className="text-sm text-slate-500">Knaus et al. Crit Care Med. 1985;13(10):818-829</p>
        </div>
