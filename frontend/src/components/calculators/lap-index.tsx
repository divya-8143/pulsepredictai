...
export default function LAP_INDEXCalculator({
  initialAge = 52,
  initialGender = "MALE",
  initialSystolic = 135,
  initialDiastolic = 85,
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto p-4">
      <div className="flex items-center justify-between border-b pb-4">
        <div>
          <h2 className="text-2xl font-bold text-slate-900">Lipid Accumulation Product (LAP) for Cardiovascular & Metabolic Risk</h2>
          <p className="text-sm text-slate-500">Kahn et al. BMC Cardiovasc Disord. 2005;5:26</p>
        </div>
