...
export default function GRACE_2Calculator({
  initialAge = 52,
  initialGender = "MALE",
  initialSystolic = 135,
  initialDiastolic = 85,
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto p-4">
      <div className="flex items-center justify-between border-b pb-4">
        <div>
          <h2 className="text-2xl font-bold text-slate-900">GRACE 2.0 Risk Score for Acute Coronary Syndrome Mortality</h2>
          <p className="text-sm text-slate-500">Fox et al. BMJ. 2014;348:g3401</p>
        </div>
