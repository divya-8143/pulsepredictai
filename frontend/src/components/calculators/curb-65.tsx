...
export default function CURB_65Calculator({
  initialAge = 52,
  initialGender = "MALE",
  initialSystolic = 135,
  initialDiastolic = 85,
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto p-4">
      <div className="flex items-center justify-between border-b pb-4">
        <div>
          <h2 className="text-2xl font-bold text-slate-900">CURB-65 Severity Score for Community-Acquired Pneumonia</h2>
          <p className="text-sm text-slate-500">Lim et al. Thorax. 2003;58(5):377-382</p>
        </div>
