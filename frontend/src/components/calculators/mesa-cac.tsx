...
export default function MESA_CACCalculator({
  initialAge = 52,
  initialGender = "MALE",
  initialSystolic = 135,
  initialDiastolic = 85,
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto p-4">
      <div className="flex items-center justify-between border-b pb-4">
        <div>
          <h2 className="text-2xl font-bold text-slate-900">Multi-Ethnic Study of Atherosclerosis (MESA) 10-Year CHD Risk with Agatston CAC</h2>
          <p className="text-sm text-slate-500">McClelland et al. J Am Coll Cardiol. 2015;66(15):1643-1653</p>
        </div>
