...
export default function WELLS_DVTCalculator({
  initialAge = 52,
  initialGender = "MALE",
  initialSystolic = 135,
  initialDiastolic = 85,
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto p-4">
      <div className="flex items-center justify-between border-b pb-4">
        <div>
          <h2 className="text-2xl font-bold text-slate-900">Wells Criteria for Deep Vein Thrombosis (DVT) Probability</h2>
          <p className="text-sm text-slate-500">Wells et al. Lancet. 1997;350(9094):1795-1798</p>
        </div>
