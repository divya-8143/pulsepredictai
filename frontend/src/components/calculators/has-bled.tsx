...
export default function HAS_BLEDCalculator({
  initialAge = 52,
  initialGender = "MALE",
  initialSystolic = 135,
  initialDiastolic = 85,
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto p-4">
      <div className="flex items-center justify-between border-b pb-4">
        <div>
          <h2 className="text-2xl font-bold text-slate-900">HAS-BLED Score for Major Bleeding Risk in Atrial Fibrillation</h2>
          <p className="text-sm text-slate-500">Pisters et al. Chest. 2010;138(5):1093-1100</p>
        </div>
