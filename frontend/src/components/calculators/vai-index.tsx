...
export default function VAI_INDEXCalculator({
  initialAge = 52,
  initialGender = "MALE",
  initialSystolic = 135,
  initialDiastolic = 85,
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto p-4">
      <div className="flex items-center justify-between border-b pb-4">
        <div>
          <h2 className="text-2xl font-bold text-slate-900">Visceral Adiposity Index (VAI) for Cardiometabolic Risk</h2>
          <p className="text-sm text-slate-500">Amato et al. Diabetes Care. 2010;33(4):920-922</p>
        </div>
