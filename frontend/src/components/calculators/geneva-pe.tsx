...
export default function GENEVA_PECalculator({
  initialAge = 52,
  initialGender = "MALE",
  initialSystolic = 135,
  initialDiastolic = 85,
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto p-4">
      <div className="flex items-center justify-between border-b pb-4">
        <div>
          <h2 className="text-2xl font-bold text-slate-900">Revised Geneva Score for Pulmonary Embolism</h2>
          <p className="text-sm text-slate-500">Le Gal et al. Ann Intern Med. 2006;144(3):165-171</p>
        </div>
