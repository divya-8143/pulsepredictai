...
export default function KDIGO_AKICalculator({
  initialAge = 52,
  initialGender = "MALE",
  initialSystolic = 135,
  initialDiastolic = 85,
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto p-4">
      <div className="flex items-center justify-between border-b pb-4">
        <div>
          <h2 className="text-2xl font-bold text-slate-900">KDIGO Staging Criteria for Acute Kidney Injury</h2>
          <p className="text-sm text-slate-500">KDIGO AKI Work Group. Kidney Int Suppl. 2012;2(1):1-138</p>
        </div>
