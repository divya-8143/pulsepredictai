...
export default function METS_IRCalculator({
  initialAge = 52,
  initialGender = "MALE",
  initialSystolic = 135,
  initialDiastolic = 85,
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto p-4">
      <div className="flex items-center justify-between border-b pb-4">
        <div>
          <h2 className="text-2xl font-bold text-slate-900">Metabolic Score for Insulin Resistance (METS-IR)</h2>
          <p className="text-sm text-slate-500">Bello-Chavolla et al. J Clin Endocrinol Metab. 2018;103(10):3886-3896</p>
        </div>
