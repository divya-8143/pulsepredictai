...
export default function CHA2DS2_VAScCalculator({
  initialAge = 52,
  initialGender = "MALE",
  initialSystolic = 135,
  initialDiastolic = 85,
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto p-4">
      <div className="flex items-center justify-between border-b pb-4">
        <div>
          <h2 className="text-2xl font-bold text-slate-900">CHA2DS2-VASc Score for Atrial Fibrillation Stroke Risk</h2>
          <p className="text-sm text-slate-500">Lip et al. Chest. 2010;137(2):263-272</p>
        </div>
