...
export default function NAFLD_FSCalculator({
  initialAge = 52,
  initialGender = "MALE",
  initialSystolic = 135,
  initialDiastolic = 85,
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto p-4">
      <div className="flex items-center justify-between border-b pb-4">
        <div>
          <h2 className="text-2xl font-bold text-slate-900">NAFLD Fibrosis Score for Advanced Liver Fibrosis</h2>
          <p className="text-sm text-slate-500">Angulo et al. Hepatology. 2007;45(4):846-854</p>
        </div>
