  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto p-4">
      <div className="flex items-center justify-between border-b pb-4">
        <div>
          <h2 className="text-2xl font-bold text-slate-900">QRISK3 10-Year Cardiovascular Disease Risk Algorithm</h2>
          <p className="text-sm text-slate-500">Hippisley-Cox et al. BMJ 2017;357:j2099</p>
        </div>
