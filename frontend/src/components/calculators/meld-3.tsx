...
export default function MELD_3Calculator({
  initialAge = 52,
  initialGender = "MALE",
  initialSystolic = 135,
  initialDiastolic = 85,
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto p-4">
      <div className="flex items-center justify-between border-b pb-4">
        <div>
          <h2 className="text-2xl font-bold text-slate-900">MELD 3.0 Model for End-Stage Liver Disease Score</h2>
          <p className="text-sm text-slate-500">Kim et al. Gastroenterology. 2021;161(6):1887-1895</p>
        </div>
