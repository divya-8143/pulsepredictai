...
export default function HyperkalemiaRaasiManagementFlowVisualizer() {
      ...
      <div className="flex items-center justify-between border-b pb-3">
        <div>
          <span className="text-[10px] font-bold uppercase tracking-wider text-indigo-600 bg-indigo-50 px-2 py-0.5 rounded border border-indigo-200">
            Nephrology Decision Tree
          </span>
          <h3 className="text-base font-bold text-slate-900 mt-1">KDIGO 2023 RAASi Optimization with Potassium Binders (Patiromer/SZC) Flow</h3>
        </div>
