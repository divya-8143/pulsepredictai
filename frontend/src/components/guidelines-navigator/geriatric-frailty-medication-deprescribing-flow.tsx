...
export default function GeriatricFrailtyMedicationDeprescribingFlowVisualizer() {
      ...
      <div className="flex items-center justify-between border-b pb-3">
        <div>
          <span className="text-[10px] font-bold uppercase tracking-wider text-indigo-600 bg-indigo-50 px-2 py-0.5 rounded border border-indigo-200">
            Geriatrics Decision Tree
          </span>
          <h3 className="text-base font-bold text-slate-900 mt-1">AGS Beers Criteria 2023 Cardiovascular Deprescribing Flow</h3>
        </div>
