...
export default function IcuReadmissionPredictorAnalyticsStudio() {
      ...
      <div className="flex items-center justify-between border-b pb-4">
        <div>
          <span className="text-[10px] font-bold uppercase tracking-wider text-indigo-600 bg-indigo-50 px-2 py-0.5 rounded border border-indigo-200">
            Hospital Operations Studio
          </span>
          <h2 className="text-xl font-bold text-slate-900 mt-1">Hospital 30-Day All-Cause Unplanned Readmission Risk Stratifier</h2>
        </div>
