...
export default function RadiologyNlpExtractorAnalyticsStudio() {
    ...
    <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm space-y-6 max-w-5xl mx-auto">
      <div className="flex items-center justify-between border-b pb-4">
        <div>
          ...
          <h2 className="text-xl font-bold text-slate-900 mt-1">Structured Coronary Angiogram & Echocardiography Report Extractor</h2>
        </div>
