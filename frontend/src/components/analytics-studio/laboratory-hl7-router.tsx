...
export default function LaboratoryHl7RouterAnalyticsStudio() {
      ...
      <div className="flex items-center justify-between border-b pb-4">
        <div>
          <span className="text-[10px] font-bold uppercase tracking-wider text-indigo-600 bg-indigo-50 px-2 py-0.5 rounded border border-indigo-200">
            Health Informatics Studio
          </span>
          <h2 className="text-xl font-bold text-slate-900 mt-1">Automated Inbound LIS HL7 ORU^R01 Results Normalization Engine</h2>
        </div>
