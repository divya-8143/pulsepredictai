...
export default function AfibAnticoagulationDoacProtocolWidget() {
    ...
    <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm space-y-4 max-w-3xl mx-auto">
      <div className="flex items-center justify-between border-b pb-3">
        <div>
          ...
          <h3 className="text-base font-bold text-slate-900 mt-1">Non-Valvular Atrial Fibrillation DOAC Initiation & Renal Adjustment</h3>
        </div>
