...
export default function CardiacAmyloidosisTafamidisProtocolWidget() {
    ...
    <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm space-y-4 max-w-3xl mx-auto">
      <div className="flex items-center justify-between border-b pb-3">
        <div>
          ...
          <h3 className="text-base font-bold text-slate-900 mt-1">Transthyretin Cardiac Amyloidosis (ATTR-CM) Screening & Treatment</h3>
        </div>
