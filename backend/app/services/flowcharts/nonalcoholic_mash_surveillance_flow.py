"""
EASL-AASLD 2024 Steatohepatitis (MASH) FIB-4 & ELF Surveillance Flow
...
class NonalcoholicMashSurveillanceFlowEngine:
    """
    Multi-branch algorithmic decision tree evaluator for EASL-AASLD 2024 Steatohepatitis (MASH) FIB-4 & ELF Surveillance Flow.
    """

    FLOWCHART_NAME = "EASL-AASLD 2024 Steatohepatitis (MASH) FIB-4 & ELF Surveillance Flow"
    SPECIALTY = "Hepatology"
