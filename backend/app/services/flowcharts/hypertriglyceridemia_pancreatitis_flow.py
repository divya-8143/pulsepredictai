"""
Endocrine Society Severe Hypertriglyceridemia (TG > 500) Flow
...
class HypertriglyceridemiaPancreatitisFlowEngine:
    """
    Multi-branch algorithmic decision tree evaluator for Endocrine Society Severe Hypertriglyceridemia (TG > 500) Flow.
    """

    FLOWCHART_NAME = "Endocrine Society Severe Hypertriglyceridemia (TG > 500) Flow"
    SPECIALTY = "Lipidology"
