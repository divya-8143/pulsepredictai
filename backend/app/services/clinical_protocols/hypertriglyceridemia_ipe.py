"""
Severe Hypertriglyceridemia & Icosapent Ethyl Risk Reduction
...
@dataclass
class HypertriglyceridemiaIpeContext:
    patient_id: str
    age: float
    gender: str
...
class HypertriglyceridemiaIpeProtocolEngine:
    """
    Standardized Protocol Implementation for Severe Hypertriglyceridemia & Icosapent Ethyl Risk Reduction.
    """

    PROTOCOL_NAME = "Severe Hypertriglyceridemia & Icosapent Ethyl Risk Reduction"
    SPECIALTY = "Lipidology"

    @classmethod
    def execute_protocol(cls, ctx: HypertriglyceridemiaIpeContext) -> Dict[str, Any]:
        """
    ...
    @classmethod
    def _determine_step(cls, ctx: HypertriglyceridemiaIpeContext) -> int:
    ...
    @classmethod
    def _generate_dosing_plan(cls, step: int, ctx: HypertriglyceridemiaIpeContext) -> List[Dict[str, str]]:
        if step == 3:
            return [
    ...
    @classmethod
    def _generate_monitoring_schedule(cls, step: int, ctx: HypertriglyceridemiaIpeContext) -> List[Dict[str, str]]:
        return [
    ...
    @classmethod
    def _perform_safety_checks(cls, ctx: HypertriglyceridemiaIpeContext) -> List[str]:
        alerts = []
