"""
Non-Valvular Atrial Fibrillation DOAC Initiation & Renal Adjustment
...
@dataclass
class AfibAnticoagulationDoacContext:
    patient_id: str
    age: float
    gender: str
...
class AfibAnticoagulationDoacProtocolEngine:
    """
    Standardized Protocol Implementation for Non-Valvular Atrial Fibrillation DOAC Initiation & Renal Adjustment.
    """

    PROTOCOL_NAME = "Non-Valvular Atrial Fibrillation DOAC Initiation & Renal Adjustment"
    SPECIALTY = "Electrophysiology"

    @classmethod
    def execute_protocol(cls, ctx: AfibAnticoagulationDoacContext) -> Dict[str, Any]:
        """
    ...
    @classmethod
    def _determine_step(cls, ctx: AfibAnticoagulationDoacContext) -> int:
    ...
    @classmethod
    def _generate_dosing_plan(cls, step: int, ctx: AfibAnticoagulationDoacContext) -> List[Dict[str, str]]:
        if step == 3:
            return [
    ...
    @classmethod
    def _generate_monitoring_schedule(cls, step: int, ctx: AfibAnticoagulationDoacContext) -> List[Dict[str, str]]:
        return [
    ...
    @classmethod
    def _perform_safety_checks(cls, ctx: AfibAnticoagulationDoacContext) -> List[str]:
        alerts = []
